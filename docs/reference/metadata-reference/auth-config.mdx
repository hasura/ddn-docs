...
| `version` | `v4` | true |  |
| `definition` | [AuthConfig4](#authconfig-authconfig4) | true | Definition of the authentication configuration v4, used by the API server. |



#### AuthConfig4 {#authconfig-authconfig4}
...
| `kind` | `AuthConfig` | true |  |
| `version` | `v3` | true |  |
| `definition` | [AuthConfig3](#authconfig-authconfig3) | true | Definition of the authentication configuration v3, used by the API server. |
...
| `kind` | `AuthConfig` | true |  |
| `version` | `v2` | true |  |
| `definition` | [AuthConfig2](#authconfig-authconfig2) | true | Definition of the authentication configuration v2, used by the API server. |
...
| `kind` | `AuthConfig` | true |  |
| `version` | `v1` | true |  |
| `definition` | [AuthConfig1](#authconfig-authconfig1) | true | Definition of the authentication configuration v1, used by the API server. |

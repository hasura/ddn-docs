...
description:
  "Reference documentation for the setup process for the Hasura Oracle connector, including connection URI details,
  and native queries."
keywords:
  - oracle
  - configuration
...
For example, with MySQL to enable running multiple statements in a given query:
```json
{

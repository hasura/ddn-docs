...
To see more examples, check out our getting started guide for [adding custom business logic](/quickstart.mdx) or
database-specific guides for [creating mutations](/quickstart.mdx).

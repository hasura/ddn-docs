...
You can add another function simply by exporting a valid TypeScript function. If `ddn dev` is running, the change will
automatically be picked up the CLI, the associated metadata for the command will be generated, and you will be able to
use your function by name in the GraphQL API.

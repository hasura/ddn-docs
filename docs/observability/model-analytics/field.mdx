...
Field analytics can be accessed via the `Analytics` tab within the `Explorer` panel for any specific model or command, allowing users to view data for either the project API or of a single build

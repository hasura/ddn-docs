...
Operation analytics can be accessed via the `Analytics` tab within the `Explorer` panel for any specific model or command, allowing users to view data for either an entire project or a single build

...
{`curl -L https://graphql-engine-cdn.hasura.io/ddn/cli/${props.version || 'v3'}/get.sh | bash`}
</CodeBlock>
...
<CodeBlock language="bash">
{`curl -L https://graphql-engine-cdn.hasura.io/ddn/cli/${props.version || 'v3'}/latest/cli-ddn-windows-amd64.exe -o ddn.exe`}
</CodeBlock>

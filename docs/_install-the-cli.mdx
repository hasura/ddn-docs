...
{`curl -L https://graphql-engine-cdn.hasura.io/ddn/cli/${props.revision || 'v3'}/get.sh | bash`}
</CodeBlock>
...
<CodeBlock language="bash">
{`curl -L https://graphql-engine-cdn.hasura.io/ddn/cli/${props.revision || 'v3'}/latest/cli-ddn-windows-amd64.exe -o ddn.exe`}
</CodeBlock>

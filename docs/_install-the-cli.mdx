...
<CodeBlock language="bash">
  {`curl -L https://graphql-engine-cdn.hasura.io/ddnreference/cli/${props.revision || "v4"}/get.sh | bash`}
</CodeBlock>

</TabItem>

<TabItem value="windows" label="Windows">
- Download the latest <a href={`https://graphql-engine-cdn.hasura.io/ddnreference/cli/${props.revision || "v4"}/latest/DDN_CLI_Setup.exe`}>DDN CLI installer for Windows.</a> 

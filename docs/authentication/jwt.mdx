---
description: Use authentication with JWT in Hasura DDN
keywords:
  - hasura
  - docs
  - authentication
...
| `claimsMap`           | String       | false    | Object (in a string format) of session variables to the pointer or literal value where the Hasura claims object should be looked up in the decoded JWT.                                                                                        |

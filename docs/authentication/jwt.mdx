...
tokenLocation: "<optional-object-to-indicate-cookie-or-authorization-header-or-custom->"
...
|-----------------|-------------------------------------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `key`           | [`JWT key`](#jwt-key)               | true     | JWT key type to configure the JWT authentication.                                                                                                                                                  |
| `claimsConfig`  | [Claims Config](#jwt-claims-config) | true     | Configuration of the Hasura claims within the JWT.                                                                                                                                                 |
| `tokenLocation` | Object                              | true     | Declares the request header or the cookie (with cookie name) from which to read the JWT. Default: ```json { "type": ```[Token location value](#jwt-token-location-value) }.                        |
...
| Field        | Type                        | Required | Description                                                                                                       |
|--------------|-----------------------------|----------|-------------------------------------------------------------------------------------------------------------------|
| `fixed`      | [Fixed key](#fixed-jwt-key) | false    | Fixed JWT mode, when the `algorithm` and the `key` fields are known and aren't expected to change during runtime. |
...
#### JWT token location values {#jwt-token-location-values}

| Field                 | Type   | Required | Description                                                                                                                                                   |
|-----------------------|--------|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `BearerAuthorization` | String | false    | JWT is provided in the `Authorization` header in the format of `Bearer <JWT>`                                                                                 |
| `Header`              | Object | false    | Name of the header which will contain the JWT. An JSON object with the name of the custom header is expected like: ```{ "Header": "<custom-header-name>" }``` |
| `Cookie`              | Object | false    | JWT is provided in the `Cookie` header. An JSON object with the name of the cookie is expected like: ```{ "Cookie": "<custom-cookie-name>" }```                                                                                                                                                              |

...
You can configure authentication to allow certain roles to emulate other roles. This can be useful to test
access-control rules without setting up authentication for a role.

...
description:
  Get detailed guidance on setting up Hasura authentication for incoming requests. Uncover the structure of the
  AuthConfig metadata object supporting JWT and webhook methods.
keywords:
  - hasura authconfig
...
|------------------------|--------|----------|--------------------------------------------------------------------------------------------------------------------------|
| `allowRoleEmulationBy` | String | false    | Name of the role which allows role emulation. Read more about role emulation [here](/authentication/role-emulation.mdx). |

...
:::info Start your free trial!

You can try out the Hasura DDN Base plan for free for 30 days without adding a payment method. For a given user, only one
trial project can be created. [Try it out now!](https://hasura.io/pricing/v3)

...
:::info Start your free Base Trial Plan!

The Base Trial Plan offers new users the opportunity to experience our base plan free of charge for 30 days.

**Details:**
- **Activation**: The trial is activated immediately and is free for 30 days.
- **Expiration**: Once the trial period ends, the account is automatically downgraded to the free plan.
- **No Automatic Conversion**: Users will not be charged or automatically converted to the base plan after the trial expires.
- **One-Time Offer**: This trial is available only once per user.

**Base Trial Plan Features:**
- Unlimited collaboration for your team.
- Real-time performance metrics and query tracing for 30 days.
- Model/Field Analytics & insights for the last 30 days.
- Schema registry and tracking.

This ensures that users can explore the full benefits of the base plan without any commitment or automatic billing.

...
<Thumbnail src="/img/deployment/hasura-ddn/ddn_architecture.png" alt="DDN Architecture" />
...
<Thumbnail src="/img/deployment/hasura-ddn/private_ddn.png" alt="Hasura Privaet DDN Architecture" />
...
<Thumbnail src="/img/deployment/hasura-ddn/multi_region_postgres.png" alt="DDN multi-region routing" />

...
<Thumbnail src="/img/deployment/hasura-ddn/private_ddn_byoc.png" alt="Private DDN Architecture BYOC " />
...
<Thumbnail
  src="/img/deployment/hasura-ddn/private_ddn_byoc_detailed.png"

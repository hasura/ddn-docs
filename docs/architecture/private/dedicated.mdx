...
Hasura manages the deployment, uptime, and availability of the [Data Plane](/architecture/overview.mdx#data-plane) for
you.
...
<Thumbnail
  src="/img/deployment/hasura-ddn/private_ddn_hasura_hosted.png"
  alt="Private DDN Architecture Hasura Hosted"
/>

...
By default, all Hasura DDN projects are in `Private` API Access Mode. You can navigate to the project's settings and
toggle the setting to `Public`. **Note: Your API will be accessible from any source. You should protect it using either

...
After initializing the connector, they then introspect the database, add the necessary models, commands, and
relationships to their subgraph:
...
This will initialize a new connector in their local project. They can then introspect and add the models, commands, and
...
### Step 4. Team Two: Build and deploy their supergraph _without_ building the connector

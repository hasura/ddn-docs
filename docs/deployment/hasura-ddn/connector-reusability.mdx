...
### Step 1: Team one: Initialise and build the supergraph and deploy the connector
...
Team two, say the "Reviews" team, should initialize their own project and connector with the connection information to

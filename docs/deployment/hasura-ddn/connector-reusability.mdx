...
#### Step 1.1: Introspect the database
...
#### Step 1.3: Set a connector region
...
#### Step 1.5: Add a service token secret
...
#### Step 1.6: Build and deploy the connector

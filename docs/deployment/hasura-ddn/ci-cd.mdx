...
Indeed, a windows or mac environment will work and run the DDN CLI but for CI/CD pipelines, we recommend using a linux
...
[See here](https://github.com/hasura/ddn-deployment). The process which we will go through below is as follows:

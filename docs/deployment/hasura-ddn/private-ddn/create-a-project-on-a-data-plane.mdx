...
[Private Hasura DDN](/deployment/hasura-ddn/private-ddn/index.mdx). Before proceeding, you'll first need to be
[invited](/deployment/hasura-ddn/private-ddn/data-plane-collaboration.mdx) to a Data Plane.

...
A [Data Plane](/architecture/overview.mdx#data-plane) in Hasura provides dedicated infrastructure for running your
GraphQL workloads. This guide walks you through the process of creating a new Data Plane for
[dedicated Private DDN](/architecture/private/dedicated.mdx).
...
[creating projects](/deployment/hasura-ddn/private-ddn/create-a-project-on-a-data-plane.mdx) on your Data Plane. To
access more information about a specific Data Plane, simply click on its name within the Data Planes table. This action
will navigate you to a detailed view page of the selected Data Plane, as illustrated below.
...
[learn how to add collaborators](/deployment/hasura-ddn/private-ddn/data-plane-collaboration.mdx) so they can create
projects.

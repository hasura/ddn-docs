...
For data connectors that connect to a data source, e.g. [PostgreSQL](/connectors/postgresql/index.mdx), it is
...
in a region closest to the consumers of the API to ensure efficient communication between the connector and the Hasura
engine.

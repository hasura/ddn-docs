...
You can create a build of the rest of the supergraph but direct Hasura DDN to use the new specific subgraph build.

```bash
ddn supergraph build create --subgraph-version <subgraph-name>:<subgraph-build-version>
```

...
This guide will walk you through the steps for creating a project on a Data Plane in Private Hasura DDN. Before proceeding,
...
You'll create a new project using the DDN CLI and by passing two flags: the `data-plane-id` and the
`plan`.

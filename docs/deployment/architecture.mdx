...
The Hasura DDN Data Plane runs an enhanced version of v3 engine which is capable
...
on self-hosted Hasura DDN if the network capabilities of the infrastructure
allows it.

...
- [Hasura VS Extension](/getting-started/build/prerequisites#install-lsp) (Recommended, but not required)
...
:::info The URL of these environment variables is structured as such


**https://`<connector-helm-release-name>`-`<connector-helm-chart-name>`.`<namespace>`:8080**

...
sidebar_label: Managing Supergraph Builds
keywords:
  - graphql
  - graphql analysis
  - hasura v3
...
## List Supergraph Builds from the CLI
...
If you don't have any Supergraph builds yet, check out our [Getting Started](/getting-started/build/index.mdx) guide to

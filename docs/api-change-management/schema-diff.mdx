...
Imagine you already have supergraph build 'A' applied to your Hasura DDN project and you want to see the impact of
applying a new supergraph build 'B'. You can select build 'A' as the `Reference Build` and build 'B' as the `Compare
Build` to compare the schemas.

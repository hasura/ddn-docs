...
description:
  "Establish a secure connection between local databases and your Hasura-hosted Data Delivery Network (DDN) projects
  with Secure Connect Tunnels. By creating tunnels using Hasura CLI, you can iteratively work on projects, handle
  sensitive information, and test local data connectors securely."
keywords:
  - secure connection
  - hasura ddn
  - local databases
...
[TypeScript connector](https://github.com/hasura/ndc-typescript-deno), before [deploying](/connectors/deployment.mdx)
them to Hasura DDN.

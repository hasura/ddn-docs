...
to interact with a local database via your Hasura project and use the Hasura Console and other Hasura
services.
...
The Hasura CLI creates and manages tunnels. The CLI utilizes a [daemon](https://en.wikipedia.org/wiki/Daemon_(computing)) that runs in the background

...
description: "Discover how to establish a secure connection between local databases and your Hasura-hosted Data Delivery Network (DDN) projects with Secure Connect Tunnels. By creating tunnels using Hasura CLI, you can iteratively work on projects, handle sensitive information, and test local data connectors securely. Ideal for developers utilizing local databases for faster deployment and iterations."
keywords:
  - secure connection
  - hasura ddn
  - local databases

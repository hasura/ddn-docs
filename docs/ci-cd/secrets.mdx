...
description: "Discover secrets within Hasura DDN, a secure method for storing vital data as key-value pairs. Learn to utilize complexity-free commands for setting, managing, and thawing your secrets. Shield your sensitive parameters like database credentials and API keys, promoting elevated levels of security."
keywords:
  - secrets management
  - key-value data
  - api security

...
Build profiles tell Hasura DDN how to construct your supergraph. A build profile will contain information about the shared
resources — such as your authentication configuration — and the resources belonging to the individual subgraphs that make up
your supergraph.

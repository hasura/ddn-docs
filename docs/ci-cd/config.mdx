...
description: "Learn about the configuration process for Hasura's Data Delivery Network. Discover detailed instructions on utilizing Hasura CLI for efficient project management, configuring build profiles, subgraphs, and in-depth understanding on hasura.yaml. Simplify your tasks of setting up projects, managing metadata and enhancing version control with Hasura."
keywords:
  - hasura ddn

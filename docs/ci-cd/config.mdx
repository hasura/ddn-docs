...
The `CompatibilityConfig` object contains a `date` field which opts your metadata into all backwards incompatible
changes up until that date. Any backwards incompatible changes made to Hasura DDN after that date won't impact your
metadata.

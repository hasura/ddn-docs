...
The `auth-config.hml` file defines the authorization configuration for your supergraph i.e. the configuration for
how the queries to your Hasura DDN project should be authorized. The `compatibility-config.hml` file defines the

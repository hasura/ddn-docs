...
:::info customize the default subgraph

You can customize the default subgraph by:

1. [Deleting the `app` subgraph](/cli/commands/delete-subgraph.mdx) on DDN.
2. [Creating a new subgraph](/cli/commands/create-subgraph.mdx) with the desired name.

...
description: "Easily share and manage Hasura DDN projects with collaborators, granting them specific roles and access to project's metadata, builds, and console metrics."
keywords:
  - hasura ddn
  - graphql api

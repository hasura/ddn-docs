...
Environments allow you to organize your [project](/ci-cd/projects.mdx) metadata by `development` or `production`
...
Once you've created an environment, you can then use it to create different builds by configuring a build profile
file to reference the environment name under the `environments` key:

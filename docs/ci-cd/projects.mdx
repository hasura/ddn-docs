...
Follow the steps in the wizard to create a new project.
...
helps you author and edit `hml` files in your subgraphs. It provides syntax highlighting, validation, and
autocompletion.

To use the extension, [install it](https://marketplace.visualstudio.com/items?itemName=HasuraHQ.hasura). Then, you can
access the extension by pressing `Ctrl+Shift+P` on Windows and `Cmd+Shift+P` on Mac and then typing `hasura` to see the
list of commands.

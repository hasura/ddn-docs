...
To use the extension, ensure you've [installed it](https://marketplace.visualstudio.com/items?itemName=HasuraHQ.hasura)
and then run the `login` command using the command palette. You can access this by pressing `Ctrl+Shift+P` on Windows

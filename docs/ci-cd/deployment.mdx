...
You'll also need to create [supergraph manifests](/ci-cd/config.mdx#supergraph-manifests) for each environment by creating new
named files in the root of your directory:
...
ddn build supergraph --supergraph-manifest staging.supergraph.hml
```

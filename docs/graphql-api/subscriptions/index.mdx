...
subscription capabilities are automatically generated for them. For futher customization, you can
...
supergraph build and test the subscriptions on the API. For futher customization, you can
[edit the metadata](#metadata-configuration).

### Metadata Configuration

You can also configure subscriptions by editing the metadata HML files in your DDN project.

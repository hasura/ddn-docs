---
description: Filter query results on PostgreSQL with Hasura
keywords:
  - hasura
  - docs
  - postgres
...
| [JSONB Operators](/graphql-api/postgresql-queries/filters/jsonb-operators.mdx)                  | Utilize JSONB operators to fine-tune result filters using JSONB fields and navigating nested objects.      |
| [PostGIS Operators](/graphql-api/postgresql-queries/filters/postgis-operators.mdx)              | Leverage PostGIS operators to narrow results based on geographical location data.                          |
| [ltree Operators](/graphql-api/postgresql-queries/filters/ltree-operators.mdx)                  | Utilize ltree operators to filter results using hierarchical ltree data.                                   |
...
| [Computed Fields](/graphql-api/postgresql-queries/filters/computed-fields.mdx)                  | Filter results based on dynamically computed fields that derive from existing data.                        |
...
- from PostgreSQL `jsonb` type to `string` type.

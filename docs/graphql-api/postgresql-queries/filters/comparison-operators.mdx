...
sidebar_position: 1
description: Learn how to filter query results and search queries on PostgreSQL using Hasura by leveraging comparison operators. This guide covers the use of equality, list-based, and value comparison operators.
keywords:
  - hasura
  - postgresql
  - sql

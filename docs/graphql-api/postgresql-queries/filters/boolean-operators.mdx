...
sidebar_position: 2
description: Learn how to create complex boolean expressions for filtering query results on PostgreSQL using Hasura. Includes examples using _not, _and, _or operators.
keywords:
  - hasura
  - postgres
  - query

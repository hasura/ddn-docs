...
sidebar_position: 7
description: Learn how to utilize nested objects fields to filter query results in PostgreSQL using Hasura. The document contains methodologies, examples, and use cases.
keywords:
  - hasura
  - postgresql
  - query filtering

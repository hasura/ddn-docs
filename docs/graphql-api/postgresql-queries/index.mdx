...
keywords:
  ...
  - database management
description: Detailed guide on how to work with PostgreSQL GraphQL Queries using the Hasura software product. Includes information on using Hasura PostgreSQL data connector and using queries with the generated GraphQL API fields and values.
...
Documentation for other data connectors can be found on the [Data Connector Hub](https://hasura.io/connector) and in the

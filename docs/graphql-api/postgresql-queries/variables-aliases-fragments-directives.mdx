...
sidebar_position: 10
description: Learn to use variables, aliases, fragments, and directives in Hasura queries to make dynamic and reusable queries. Get examples of methods for fetching data and altering your query results.
keywords:
  - hasura
  - graphql
  - hasura queries

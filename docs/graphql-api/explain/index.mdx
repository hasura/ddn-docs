---
description: Hasura explain GraphQL query execution plan
...
The v3-engine can explain the GraphQL query execution plan. The execution plan is a tree of
[ExplainStep](./api-reference/#explainstep).

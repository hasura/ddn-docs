...
sidebar_position: 8
description: Learn how to use multiple arguments in a Hasura query for more efficient database handling. This guide covers filtering and sorting results with multiple arguments.
keywords:
  - hasura tutorial
  - database query 
  - multiple arguments

...
description: Learn how to fetch single or multiple nodes using simple object queries in Hasura's GraphQL API. Discover pagination, sorting, filtering and more.
keywords:
  - hasura
  - graphql
  - api

...
| [JSONB Operators](/graphql-api/queries/filters/jsonb-operators.mdx)                  | Utilize JSONB operators to fine-tune result filters using JSONB fields and navigating nested objects.      |
| [PostGIS Operators](/graphql-api/queries/filters/postgis-operators.mdx)              | Leverage PostGIS operators to narrow results based on geographical location data.                          |
| [ltree Operators](/graphql-api/queries/filters/ltree-operators.mdx)                  | Utilize ltree operators to filter results using hierarchical ltree data.                                   |
| [Nested Objects](/graphql-api/queries/filters/using-nested-objects.mdx)              | Navigate and filter results using nested object structures for advanced filtering.                         |
| [Computed Fields](/graphql-api/queries/filters/using-computed-fields.mdx)            | Filter results based on dynamically computed fields that derive from existing data.                        |

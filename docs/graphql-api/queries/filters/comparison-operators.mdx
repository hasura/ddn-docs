...
sidebar_position: 1
description: Learn how to filter query results and search queries using Hasura by leveraging comparison operators. This guide covers the use of equality, list-based, and value comparison operators.
keywords:
  - hasura
  - sql
  - graphql
...
compatible with any type other than `json` or `jsonB` (like `Integer`, `Float`, `Double`, `Text`, `Boolean`,

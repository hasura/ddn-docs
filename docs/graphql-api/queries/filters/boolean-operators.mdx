...
sidebar_position: 2
description: Learn how to create complex boolean expressions for filtering query results on using Hasura. Includes examples using _not, _and, _or operators.
keywords:
  - hasura
  - query
  - filter

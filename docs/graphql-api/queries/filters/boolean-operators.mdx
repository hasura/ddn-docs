...
sidebar_position: 2
description: "Discover how to build complex boolean expressions for Hasura-related query filtering in API data. This guide includes examples of using '_not', '_and', and, '_or' operators for improved data filtering."
keywords:
  - hasura query
  - graphql api data
  - boolean expressions

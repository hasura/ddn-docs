...
You can also create custom insert mutations to insert data into your data source. This allows you to write any custom
logic you need to insert data using your data source's native capabilities.

...
If you've never used the TypeScript connector, we recommend you to go through the [quickstart](/local-dev.mdx).
Additionally, at the very least, check out the docs for the

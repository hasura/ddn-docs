...
Apollo Federation support in DDN only allows extending subgraphs with DDN types.

The other way i.e. extending DDN types with other subgraphs is not currently possible. i.e. the following is not
supported:

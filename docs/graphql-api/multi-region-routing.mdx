...
sidebar_position: 3
description: "Understand how to set up multi-region routing in Hasura to achieve efficient data fetching and lower latency. Benefit from optimal database performance and global data access with Hasura."
keywords:

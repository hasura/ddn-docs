...
sidebar_position: 3
description:
  "Learn about configuring multi-region routing in Hasura for optimal data fetching with minimal latency, including
  setup for PostgreSQL and supported regions."
keywords:

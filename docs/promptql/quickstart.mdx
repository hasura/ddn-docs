...
You'll set up your environment, connect a PostgreSQL data source, and enable PromptQL to unlock powerful natural
language queries.
...
### Step 1.2 — Initialize a new supergraph in a new directory

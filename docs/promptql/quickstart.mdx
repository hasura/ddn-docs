...
4. **An Anthropic or OpenAI key**

For an Anthropic key, see [here](https://docs.anthropic.com/en/api/getting-started). For an OpenAI key, see 
[here](https://platform.openai.com/docs/api-reference/introduction).
...
You can leave the `CLIENT_CERT`, `CLIENT_KEY`, and `ROOT_CERT` blank.
...
<Thumbnail src="/img/prompt-ql/console-explorer-settings.png" alt="Get Started" />

Flip the toggle on `PromptQL` and then click `Confirm`:

<Thumbnail src="/img/prompt-ql/console-settings-promptql.png" alt="Get Started" />
...
Enable the PromptQL playground in the PromptQL settings and add your LLM key:

<Thumbnail src="/img/prompt-ql/console-settings-promptql-llm-key.png" alt="Get Started" />
...
<Thumbnail src="/img/prompt-ql/console-settings-generate-promptql-key.png" alt="Get Started" />
...
`#hasura-api-world-hackathon`. Additionally, feel free to reach out to PromptQL's PM,

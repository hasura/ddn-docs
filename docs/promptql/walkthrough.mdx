...
Hasura DDN brings together all your data sources, logic and 3rd party APIs into a single GraphQL API. PromptQL is a 
...
- Adding a PostgreSQL data source with dummy data
- Adding natural language capabilities using Hasura PromptQL
- Enriching your semantic layer with descriptions for better results
- Adding semantic search for unstructured data

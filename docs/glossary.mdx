...
description:
  ...
  serverless runtime, OpenDD metadata specification, native data connectors, and more. Gain a better understanding of
  how to design and manage the Hasura architecture effectively."
keywords:
  - hasura
  - ddn
  - datadeliverynetwork
...
command. This facilitates data interconnection. [Learn more](/supergraph-modeling/relationships.mdx).

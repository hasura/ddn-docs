...
tested independently. Builds exist in in projects and there is a one-to-many mapping between projects and builds.
...
subgraphs to include and which resources to use for the build. [Learn more](/project-configuration/config.mdx#supergraph-manifests).
...
for creating builds, tracking objects, and deploying projects. [Learn more](/cli/overview.mdx).

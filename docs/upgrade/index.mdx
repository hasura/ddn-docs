...
- Speed up your workflow with [immutable builds](/project/configuration/overview.mdx breeze.
- Ensure smooth and dependable [deployments](/deployment/ddn/index.mdx), cutting down on debugging time.
...
- Easily scale with [built-in federation](/collaboration/federation.mdx) that integrates subgraphs into your Hasura DDN
  setup.

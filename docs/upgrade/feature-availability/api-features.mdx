...
for more complex and dynamic data manipulations. Learn more about GraphQL mutations
...
**In Hasura DDN, Apollo Federation is not supported**. You get the same functionality — with greater flexibility and
control — using Hasura's native federation capabilities.

...
Currently, we support business logic via the [TypeScript](/business-logic/typescript/index.mdx) and
...
**In Hasura DDN, Apollo Federation is supported**. To know more, please check [these docs](/graphql-api/apollo-federation.mdx).

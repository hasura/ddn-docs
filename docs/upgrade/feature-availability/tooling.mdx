...
Learn how the console can be used to [explore and manage your API here](basics/explore/index.mdx).
...
[new command structure here](cli/overview.mdx) or [learn how to create your first project here](/quickstart.mdx).

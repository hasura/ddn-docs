...
You can connect a local PostgreSQL database to Hasura DDN using the new [Hasura CLI](/ci-cd/hasura-cli.mdx). If you don't have a
PostgreSQL database and prefer to connect to a cloud provider, check out our friends at [Neon](https://neon.tech).

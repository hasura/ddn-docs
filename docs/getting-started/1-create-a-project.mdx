...
A [**connector manifest**](/ci-cd/config.mdx#supergraph-manifests) is the file which contains the details of the
connector's configuration. This tells Hasura DDN what capabilities the connector has and how to build that connector for
your data source.
...
<summary>
  We also have other data sets available in this dropdown or, if you wish, you can add your own connection string.
</summary>
...
Next, update your `app_connector.build.hml` file to reference this new environment variable:

...
Additionally, it will log some information about the [project](/docs/project-configuration/projects.mdx) that was created locally.
...
A [**build**](/project-configuration/builds.mdx) in Hasura DDN is an immutable state of your GraphQL API that represents a milestone in
your development cycle.

Each [**project**](/project-configuration/projects.mdx) can have multiple builds, but only one can be applied to a the project's

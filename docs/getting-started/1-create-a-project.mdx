...
[connectors were deployed](/connectors/overview.mdx) automatically to Hasura DDN. Hasura can host these for you or you
can deploy them on your own infrastructure.

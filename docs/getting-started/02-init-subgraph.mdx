...
**_In the directory which you've created your supergraph_**, run the following command to create a subgraph:
...
This command created a directory in your project with the subgraph name you provided with an empty

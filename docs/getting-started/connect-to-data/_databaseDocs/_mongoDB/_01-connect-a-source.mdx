...
```bash
ddn connector init my_mongo --subgraph my_subgraph --hub-connector hasura/mongodb --configure-port 8082
```
...
collisions with other connectors or services which you might have running on your machine.

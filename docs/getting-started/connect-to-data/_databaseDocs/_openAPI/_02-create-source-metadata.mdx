...
- An [OpenAPI connector](/getting-started/connect-to-data/connect-a-source) initialized
...
document in `hml`. Learn how to do this by [adding source entities](/getting-started/connect-to-data/add-source-entities).

...
sidebar_label: "IV: Add another subgraph"
sidebar_position: 4
...
Alternatively, you could add this as an [environment variable](/project-configuration/config.mdx#envyaml) as we did in

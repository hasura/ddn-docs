...
In this section, we'll guide you through the hands-on process of building and refining an API **locally**. If you
choose, you can also deploy it to Hasura DDN. You'll notice the frequent use of CLI commands throughout this section.
This is by design. The DDN CLI is crafted to perform tasks atomically, enabling you to achieve specific outcomes
efficiently. Once you're comfortable, you can combine these commands into your own scripts, streamlining the creation
and iteration of your APIs.

**We also recommend you use your own data sources to effectively grok the concepts we're covering.** However, when
connecting a data source, we'll share some sample connection strings with you.

## What am I building?

Hasura DDN combines multiple data sources and logic into a single, inter-related and high-performance API. The entire
API is defined in metadata with a YAML-like syntax.

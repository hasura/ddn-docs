...
A valid supergraph is compiled into an immutable build, which powers the resultant API. In turn, the API build
...
Hasura DDN also includes a Console for querying the API as well as a visual explorer for browsing the supergraph,

...
[exposing a model](/getting-started/connect-to-data/03-expose-source-entities.mdx), we'll create a new local build of
our API.
...
- [Models added](/getting-started/connect-to-data/03-expose-source-entities.mdx) to your subgraph

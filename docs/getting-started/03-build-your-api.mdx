...
In GraphQL, you can provide a name for your query, which in this example is `MyFirstQuery`. This name is customizable
by you at query time and just helps with logging and debugging.

...
cloud hosted connector to be able to communicate with the OpenAPI data source.
...
Eg: `NDC_OAS_BASE_URL=https://petstore3.swagger.io/api/v3`
...
root directory of the subgraph which contains your connector. Within this, you'll add the cloud connector's URLs

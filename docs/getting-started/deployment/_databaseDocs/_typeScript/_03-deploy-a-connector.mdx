...
You can now build and deploy your connector on Hasura DDN. Simply run the following replacing the directory names
with those that reflect your project if necessary.

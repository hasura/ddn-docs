...
[`CompatibilityConfig`](/supergraph-modeling/compatibility-config.mdx) can be located in any subgraph.
On `supergraph init` though, we create this for you in a dedicated subgraph called `globals`, just for the sake of
organization.

...
For each subgraph you're deploying, run the following to create it on Hasura DDN:
...
Thus, for each subgraph you have in local metadata, you'll create the companion on Hsaura DDN.

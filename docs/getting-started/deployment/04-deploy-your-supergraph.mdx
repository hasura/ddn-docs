...
ddn supergraph build create \
  ...
  --subgraph-env-file my_subgraph:my_subgraph/.env.my_subgraph.cloud
```
...
The CLI will respond with a build version and build **Console URL**. Click on it! You can go ahead and explore the API
for this build in the Hasura Console!

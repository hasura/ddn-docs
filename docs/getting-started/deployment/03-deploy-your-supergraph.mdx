...
You're about to deploy your API to our globally-distributed, highly-available, data delivery network: Hasura DDN.
...
- For each connector related to a supergraph, a
  [deployed data connector](/getting-started/deployment/02-deploy-a-connector.mdx)

...
Click on the `Explorer` button in the sidenav to quickly and easily see a visualization of your entire [supergraph](/basics/core-concepts#supergraph):
...
By clicking on an individual [subgraph](/basics/core-concepts#how-do-i-build-a-subgraph), you'll see only its details: the connectors belonging to it, and their models and
commands.
...
If you have a high number of [connectors](/connectors/introduction) within a subgraph, it may be easier to view a single data source's models and

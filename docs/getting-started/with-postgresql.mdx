...
project, connect it to a new PostgreSQL database, and run your first query.
...
```sh title="Now, you'll track the tables in your PostgreSQL database:"
...
can explore more advanced features like relationships, permissions, and more.

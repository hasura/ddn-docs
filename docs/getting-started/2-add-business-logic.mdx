...
Let's take a look at doing this with the Node.js Lambda Connector with TypeScript.
...
First, we introduced you to a quick and easy way of adding custom business logic to your API. As we learned on the
previous page, Hasura can host your TypeScript connector for you, or you can host it yourself.

...
[Follow the steps ](/getting-started/collaborate/invite.mdx#how-to-invite-collaborators) to invite subgraph
...
[Reference these docs](/getting-started/collaborate/invite.mdx#how-to-accept-a-collaboration-invite) to accept an

...
Customize the scaffolded subgraph name as needed.
...
You'll need to [deploy the connector](/getting-started/deployment/deploy-a-connector/) so it's available in your cloud
project.

#### Step 8. Create a supergraph build

...
| **Subgraph Admin** *     | All subgraph-related abilities: create subgraph build, apply subgraph build to endpoint, create supergraph with subgraph patch. |
...
| Permissions                                                       | Project Owner | Project Admin | Project Viewer | Subgraph Admin * | Subgraph Developer * |
|-------------------------------------------------------------------|---------------|---------------|----------------|------------------|----------------------|

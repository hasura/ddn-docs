...
| **Project Viewer**       | Only explore and visualize the supergraph.                                                           |
...
| Create supergraph builds with subgraph metadata patch * | ✅             | ✅             | ❌              | ✅                | ✅                    |
| Create subgraph builds *                                | ✅             | ✅             | ❌              | ✅                | ✅                    |
| Apply subgraph builds to project endpoint *             | ✅             | ✅             | ❌              | ✅                | ❌                    |
| Create supergraph builds with all subgraphs' metadata   | ✅             | ✅             | ❌              | ❌                | ❌                    |

...
In order to add collaborators, your project must either be a [DDN Base or DDN Advanced project](https://hasura.io/pricing/ddn).
...
| Role  | Abilities                                                                                                                                                                                                                                             |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Owner | All Project abilities including deletion. **At this time, project ownership is not transferrable.** |
| Admin | Same as a project owner, excluding deletion.                                                                                                                                                |
...
[https://console.hasura.io](https://console.hasura.io) where you can accept it and then explore and contribute to the project.

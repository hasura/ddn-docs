...
| Role               | Abilities                                                                                                                                                     |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Project Owner      | All Project abilities including deletion. At this time, project ownership is not transferrable.                                                               |
| Supergraph Admin   | Same as a project owner, excluding deletion.                                                                                                                  |

...
```bash
hasura3 metadata add-hub-connector pg_1 --dir . --subgraph default --id hasura/postgres --url postgresql://read_only:kd4555jkfjfkdj39f8f8d9d@35.236.11.122:5432/v3-docs-sample-app2
```

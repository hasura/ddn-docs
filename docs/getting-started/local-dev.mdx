...
description: Learn how to create a new Hasura project using VS Code and new Hasura CLI, connect to a database, and execute your first query to enhance your GraphQL application development process.
keywords:
  - hasura
  - graphql
  - vs code

...
Switch to VS Code and open `subgraphs/default/dataconnectors/ts_logic/ts_logic.hml`. The function `helloWorld` will be
...
:::info If the code action doesn't show up

Saving the file usually triggers the code action. If it doesn't, try closing and reopening the file.

...
`ddn supergraph init` will always be the first command you run when starting a new project.

:::info Specifying a directory

You can pass a directory name to the `--dir` flag to create a supergraph in a specific directory. If it doesn't

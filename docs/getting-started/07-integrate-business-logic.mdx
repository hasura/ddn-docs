...
Also, install the `dotenv-cli` package globally so that if you want to, you can load and use environment variables in
your local functions from your `.env.local` file:

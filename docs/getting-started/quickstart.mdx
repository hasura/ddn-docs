...
2. **Validate the installation**
   ...
   Run the following command to validate the DDN CLI installation. It will also check if its dependencies are installed,
   are of the right version and if they are running.

...
<Step
language="bash"
code={`ddn connector-link add-resources my_connector`}
>
...
This will track all [models](/supergraph-modeling/models.mdx), [commands](/supergraph-modeling/commands.mdx), and
[relationships](/supergraph-modeling/relationships.mdx) in your supergraph. These serve as the links between your data
source's resources — such as tables — and the types exposed in your GraphQL API.
...
head to [`https://console.hasura.io/local/graphql`](https://console.hasura.io/local/graphql) and try it out!
...
[this guide](/getting-started/build/09-add-permissions.mdx).

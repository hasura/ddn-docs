...
<div className="flex flex-col gap-6">
  <div className="">
    {/* If you break this onto another line it will lose its styling becauase the markdown rendering engine will add a <p> tag. Please leave it as a single line. Thanks! */}
...
id="supergraph-init"
language="bash"
code={['ddn supergraph init mysupergraph', 'cd mysupergraph']}
...
it. [Add you first collaborator](/hasura-cloud/collaborate/invite.mdx)!

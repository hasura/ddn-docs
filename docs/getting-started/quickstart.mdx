...
for it to use, and — if applicable — enter the connection URI. Additionally, the CLI will add a
[DataConnectorLink](/supergraph-modeling/data-connector-links.mdx) object to link your connector to the supergraph.
...
updates the corresponding DataConnectorLink with the objects from the data source that can be exposed via the API.

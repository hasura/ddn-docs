...
<Step
language="bash"
code={`ddn connector introspect my_connector --add-all-resources`}
>
...
Additionally, since you're passing the `--add-all-resources` flag, the CLI will also track
[models](/supergraph-modeling/models.mdx), [commands](/supergraph-modeling/commands.mdx), and
[relationships](/supergraph-modeling/relationships.mdx) in your supergraph. These serve as the links between your data
source's collections — such as tables — and the types exposed in your GraphQL API.
...
You can explore, visualize, and test your supergraph using the Hasura DDN console. Simply head to
[`https://console.hasura.io/local/graphql`](https://console.hasura.io/local/graphql) and try it out!
...
deploying your first supergraph, check out these sections of the docs to see everything your supergraph can do!

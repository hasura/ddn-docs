...
file, and VS Code helper files. This setup allows you to start and manage your supergraph services locally with Docker.
You can specify a directory for initialization using the `--dir` flag.
...
Additionally, it will create a `.env.cloud` file that contains any environment variables necessary to run your
supergraph, such as the connection string to a data source.

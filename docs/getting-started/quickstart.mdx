...
select a data connector and enter the connection details for your data source. Additionally, the CLI
will add a [DataConnectorLink](/supergraph-modeling/data-connector-links.mdx) metadata object to link your connector to
the supergraph.

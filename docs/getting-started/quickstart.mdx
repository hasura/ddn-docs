...
Start your local supergraph and connectors using Docker. When you run this command, services will start for your
supergraph, each connector you've added, and for observability tools.

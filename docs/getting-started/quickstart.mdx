...
[Data connectors](/data-sources/overview.mdx) allow you to connect to a specific type of data source (such as
PostgreSQL, MongoDB, MySQL, ClickHouse, etc.).
...
If you choose our `hasura/postgres` connector, it ships with a docker compose that runs a local PostgreSQL database. Or
you can connect to our sample PostgreSQL database using this URL:

...
<div className="flex flex-col xl:flex-row gap-6 xl:gap-12">
   ...
   <p className="text-[1.3rem]">In less than <em>2 minutes</em> and without a data source connection string if you don't have one, you can have your first supergraph API deployed on Hasura DDN.</p>
   </div>
   <div className="flex-1">
      <iframe

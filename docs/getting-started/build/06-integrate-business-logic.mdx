...
[next page](/getting-started/build/create-a-relationship), or you can learn about
[mutating data](/getting-started/build/mutate-data) using the TypeScript connector.

...
To add our function, similar to how we added our individual in previous guides, we can use the following to generate the
related our metadata that will link together any functions in this `functions.ts` file and our API.

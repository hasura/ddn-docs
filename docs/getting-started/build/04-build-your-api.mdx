...
[exposing a model](/getting-started/build/03-connect-to-data/03-add-source-entities.mdx), we'll create a new local build of
our API.
...
- [Models added](/getting-started/build/03-connect-to-data/03-add-source-entities.mdx) to your subgraph
...
- [Create relationships](/getting-started/build/create-a-relationship) between models
- [Mutate your data](/getting-started/build/mutate-data) with Hasura DDN

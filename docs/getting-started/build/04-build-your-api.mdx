...
you can create a new local build of your API.
...
Next, we recommend learning how easy it is to [add authorization rules](/getting-started/build/09-add-permissions.mdx),
...
- [Add permissions](/getting-started/build/09-add-permissions.mdx) to your models

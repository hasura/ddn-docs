...
[next page](/getting-started/build/08-create-a-relationship.mdx), or you can learn about
[mutating data](/getting-started/build/09-mutate-data.mdx) using the TypeScript connector.

...
- A <BaseUrlLink to="/getting-started/build/connect-to-data/connect-a-source" text="PostgreSQL connector"/> initialized
...
database using `hml`. Learn how to do this by <BaseUrlLink to="/getting-started/build/connect-to-data/add-source-entities" text="exposing source entities" />.

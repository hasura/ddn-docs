...
<!-- prettier-ignore -->
With this JSON configuration, which represents the tables in ClickHouse, we can now use it to <BaseUrlLink to="/getting-started/build/connect-to-data/create-source-metadata" text="generate Hasura metadata" />.

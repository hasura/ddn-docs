...
- A `docker-compose.my_mongo.yaml` a file to run the MongoDB data connector locally in Docker. Includes the specified
  port.
...
<BaseUrlLink to="/getting-started/build/connect-to-data/create-source-metadata" text="generate Hasura metadata" />.

...
[native queries](connectors/postgresql/native-operations/) are exposed to your API via
[models](/supergraph-modeling/models). You can use the CLI to generate an `hml` file which will
...
- A [PostgreSQL connector](/getting-started/03-connect-to-data/connect-a-source) initialized
...
create every model and command at once. This will also bring in all foreign-key relationships.

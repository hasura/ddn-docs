...
Entities from your ClickHouse database — such as tables — are exposed to your API via
[models](/supergraph-modeling/models). You can use the CLI to generate an `hml` file which will represent a model,
...
This model can now be used to [query data via your API](/getting-started/build/build-your-api). You can also customize
the model by adding access-control rules, creating relationships to other entities, or deprecating certain fields.

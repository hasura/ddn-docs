...
- A [MongoDB connector](/getting-started/03-connect-to-data/connect-a-source) initialized
- A [DataConnectorLink](/getting-started/03-connect-to-data/create-source-metadata) configured

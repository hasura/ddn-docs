...
Your models can now be used to [query data via your API](/getting-started/build/04-build-your-api.mdx). You
can also customize the model by adding [access control rules](/getting-started/build/05-add-permissions.mdx),

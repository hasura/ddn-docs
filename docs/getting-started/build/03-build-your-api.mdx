...
After [connecting a data source](/getting-started/build/connect-to-data/01-connect-a-source.mdx) and
[exposing a model](/getting-started/build/connect-to-data/03-add-source-entities.mdx), we'll create a new local build of
our API.
...
Next, we recommend learning how easy it is to [add authorization rules](/getting-started/build/06-add-permissions.mdx),
...
- [Add permissions](/getting-started/build/06-add-permissions.mdx) to your models
- [Create relationships](/getting-started/build/08-create-a-relationship.mdx) between models
- [Mutate your data](/getting-started/build/09-mutate-data.mdx) with Hasura DDN

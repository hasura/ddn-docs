...
JWT tokens to make any queries to your API. You might want to revert your `AuthConfig` to the following till you
integrate your actual authentication provider.

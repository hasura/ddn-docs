...
The `--configure-host` convenience flag added the read and write URL for the connection to the `.env.my_subgraph.local`
file for us.

```env title="Example .env.my_subgraph.local file"

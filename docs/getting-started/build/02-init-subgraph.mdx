...
This command creates a sub-directory within your supergraph directory, named after the subgraph you specified. Inside
this new sub-directory, it also creates an empty `.env.my_subgraph` file.

...
multiple data sources to your supergraph. A supergraph must have at least one subgraph, at least if you want it to
do anything. 😉
...
[include and configure a data connector](/getting-started/build/connect-to-data/index.mdx). Data connectors will enable
you to connect external data sources to your supergraph.

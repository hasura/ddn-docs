...
When you initialize a new supergraph, the CLI will create a default subgraph. However, you can follow this guide to add
subsequent subgraphs, extending your API.

...
- Existing models or commands in your supergraph which can be related to an `ObjectType`. For more information on
  ...
  [integrating business logic](/getting-started/build/integrate-business-logic) section.
...
Check out information on how to [mutate your data](/getting-started/build/mutate-data) with Hasura DDN.

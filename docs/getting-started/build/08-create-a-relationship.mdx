...
- Existing models or commands in your supergraph which can be related to an `ObjectType`. For more information on
  ...
  [adding data source entities to the API](/getting-started/build/connect-to-data/03-add-source-entities.mdx) for your
  data source. And for commands you can see the
  [integrating business logic](/getting-started/build/07-integrate-business-logic.mdx) section.
...
Check out information on how to [mutate your data](/getting-started/build/09-mutate-data.mdx) with Hasura DDN.

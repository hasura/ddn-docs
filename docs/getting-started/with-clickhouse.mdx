...
project, connect it to a new ClickHouse database, and run your first query.
...
| --------------------- | ----------------------------------------------------- | -------- |
| `CLICKHOUSE_URL`      | `clickhouse://username:password@hostname:port/dbname` | Yes      |
...
```sh title="Now, you'll track the tables in your ClickHouse database:"

...
following [these instructions](#introduction).**
...
Hasura determines the connection details for your database using the Metadata file we created when initing the project.
If you're using the docs sample app data, we have a sample `metadata.yaml` file for you
...
can learn more about Models [here](/api-schema/models.mdx).

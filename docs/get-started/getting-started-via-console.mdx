...
# Getting Started with Hasura DDN

In this guide, we'll walk you through the steps to create a new project on the Hasura DDN Console, connect a
cloud-hosted database, execute your first query, and create lightning-fast production builds. Throughout this guide,
you'll be introduced to new Hasura DDN concepts, like Builds, our new Metadata structure, and more.
...
## Step 1: Log into the Hasura DDN Console

Go to the [DDN Console](https://console.hasura.io) and sign into your account:

<Thumbnail src="/img/get-started/0.0.1_console-login.png" alt="Log into Hasura DDN Console" width="1000px" />
...
If your database has tables present, Hasura DDN automatically detected all of them and added them to your project's
Metadata 🎉
...
This is the first new concept we've introduced in this guide. Models are a new way to represent your data in Hasura DDN.
...
While we're here, check out the `Relationships` section of your Metadata file. Hasura DDN automatically detected the
...
Builds are incremental snapshots of your project's Metadata. They're a new concept in Hasura DDN that allow you to
quickly iterate and prototype on your project's Metadata.

☝️ TODO: No section or page on Builds yet...
...
Hasura DDN which allows you to quickly iterate — and, if needed, roll back — your project's Metadata to all of your
users, worldwide.**
...
We've just demonstrated how to quickly get set up and running with Hasura DDN. Now that you've got a project up and
running, you can iterate on your Metadata and build out your API. Head back to the Metadata tab, make some
modifications, create a new Build, and see what happens 🎉

### Check out the CLI

The Hasura DDN Console is a great way to get started with Hasura DDN, but it's not the only way. Check out our guide on

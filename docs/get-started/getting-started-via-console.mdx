...
- ✅ [Sample Metadata file](https://raw.githubusercontent.com/hasura/docs-sample-app/main/seeds/default/tables_seed.sql)
  (following the Open DD Spec)
...
If you're using the docs sample app data, we have a sample `metadata.yaml` file for you here 🎉

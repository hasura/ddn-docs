...
Models in the [OpenDD Spec](/supergraph-modeling/overview.mdx) refer to a collection of objects (such as rows in a
relational database, or documents in a NoSQL database) of a given OpenDD Spec [type](/supergraph-modeling/types.mdx).
Models are backed by a data source and can support CRUD operations. You can learn more about models
[here](/supergraph-modeling/models.mdx).
...
[Data Domain Modeling](/supergraph-modeling/overview.mdx) section.

...
- Duplicate names exist within a subgraph for the following definitions:
  - [`BooleanExpressionType`](/supergraph-modeling/boolean-expressions.mdx#booleanexpressiontype-booleanexpressiontype)
  - [`OrderByExpression`](/supergraph-modeling/orderby-expressions.mdx)

- Type name conflicts exist within a subgraph across the following type definitions:
  - [`ScalarType`](/supergraph-modeling/types.mdx#scalartype)
  - [`ObjectType`](/supergraph-modeling/types.mdx#objecttype)
  - [`BooleanExpressionType`](/supergraph-modeling/boolean-expressions.mdx#booleanexpressiontype-booleanexpressiontype)

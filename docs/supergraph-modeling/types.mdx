...
| `version`    | `v1`                                     | true     |             |
| `definition` | [ScalarTypeV1](#scalartype-scalartypev1) | true     |             |
...
| `version`    | `v1`                                     | true     |             |
| `definition` | [ObjectTypeV1](#objecttype-objecttypev1) | true     |             |
...
| `fieldMapping`            | [FieldMapping](#objecttype-fieldmapping)           | false    |             |

#### FieldMapping {#objecttype-fieldmapping}

| Key           | Value                                                | Required | Description |
| ------------- | ---------------------------------------------------- | -------- | ----------- |
| `<customKey>` | [ObjectFieldMapping](#objecttype-objectfieldmapping) | false    |             |

#### ObjectFieldMapping {#objecttype-objectfieldmapping}

Source field directly maps to some column in the data connector.

| Key      | Value                                                | Required | Description |
| -------- | ---------------------------------------------------- | -------- | ----------- |
| `column` | [ColumnFieldMapping](#objecttype-columnfieldmapping) | true     |             |
...
| `version`    | `v1`                                                                                        | true     |             |
| `definition` | [ObjectBooleanExpressionTypeV1](#objectbooleanexpressiontype-objectbooleanexpressiontypev1) | true     |             |

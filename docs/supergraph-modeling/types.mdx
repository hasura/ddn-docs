...
| `operators` | [EnableAllOrSpecific (OperatorName)](#objectbooleanexpressiontype-enableallorspecific_for_operatorname) | true |  |



#### EnableAllOrSpecific (OperatorName) {#objectbooleanexpressiontype-enableallorspecific_for_operatorname}

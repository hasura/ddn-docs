...
| `version`    | `v1`                                                                          | true     |                               |
| `spec`       | [ConnectorManifestSpec](#connectormanifest-connectormanifestspec)             | false    | Connector Manifest Spec       |
...
| `deployments` | [[Region](#connectormanifest-region)]             | true     | Details about the cloud deployments for the connector. |

#### Region {#connectormanifest-region}
...
| [CloudRegionDeployment](#connectormanifest-cloudregiondeployment) |             |
...
| Key       | Value                                                               | Required | Description                                    |
| --------- | ------------------------------------------------------------------- | -------- | ---------------------------------------------- |
| `region`  | [CloudDeploymentRegions](#connectormanifest-clouddeploymentregions) | true     | Region of the connector build                  |
| `mode`    | [CloudDeploymentMode](#connectormanifest-clouddeploymentmode)       | true     | Connector build deployment mode                |
...
#### CloudDeploymentMode {#connectormanifest-clouddeploymentmode}

Specifies mode for the cloud connector deployment.

**Value:** `ReadWrite` / `ReadOnly`

#### CloudDeploymentRegions {#connectormanifest-clouddeploymentregions}

Specifies region for the cloud connector deployment.

**Value:** `gcp-asia-northeast1` / `gcp-asia-south1` / `gcp-asia-southeast1` / `gcp-australia-southeast1` /
`gcp-europe-west1` / `gcp-europe-west3` / `gcp-southamerica-east1` / `gcp-us-central1` / `gcp-us-east4` / `gcp-us-west1`
/ `gcp-us-west2`

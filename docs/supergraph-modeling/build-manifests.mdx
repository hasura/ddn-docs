...
| `deployments` | [[CloudDeploymentKind](#connectormanifest-clouddeploymentkind)] | true | Details about the cloud deployments for the connector. |



#### CloudDeploymentKind {#connectormanifest-clouddeploymentkind}

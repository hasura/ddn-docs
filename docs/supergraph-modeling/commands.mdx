...
Commands are the metadata representation of these functions or procedures.
...
| `kind`       | `Command`                       | true     |             |
| `version`    | `v1`                            | true     |             |
| `definition` | [CommandV1](#command-commandv1) | true     |             |
...
| `argumentMapping`      | [ArgumentMapping](#command-argumentmapping)           | false    | Mapping from command argument names to data connector table argument names. |

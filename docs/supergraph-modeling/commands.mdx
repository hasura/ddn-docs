...
[`DataConnectorLink`](/supergraph-modeling/data-connector-links.mdx) allowing you to execute business logic directly
from your GraphQL API. You can use them to validate, process or enrich data, call another API, or even log a user in.

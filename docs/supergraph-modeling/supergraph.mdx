...
| ---- | ---- | ----------- |
| `webhook` | `object` | The configuration of the authentication webhook. |
| `jwt` | `object` | JWT config according to which the incoming JWT will be verified and decoded to extract the session variable claims. |
#### AuthHookConfig
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| `locations` | `object` | Can be used when Hasura claims are not all present in the single object, but individual claims are provided a JSON pointer within the decoded JWT and optionally a default value. |
| `namespace` | `object` | Used when all of the Hasura claims are present in a single object within the decoded JWT. |
#### JWTClaimsMap
...
| Name | Type | Description |
| ---- | ---- | ----------- |
| `fixed` | `object` | JWT Secret config according to which the incoming JWT will be decoded. |
| `jwkFromUrl` | `string` |  |
#### JWTKeyConfig

...
| [FnManifestRef](#dataconnectorlink-fnmanifestref) | Refer a ConnectorManifest to build and derive the connector URL from |



#### FnManifestRef {#dataconnectorlink-fnmanifestref}

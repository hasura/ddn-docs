...
| `representation`          | [Representation](#dataconnectorscalarrepresentation-representation)                                                          | true     | The name of the Open DD type that this data connector scalar type should be represented as. |
...
#### Representation {#dataconnectorscalarrepresentation-representation}

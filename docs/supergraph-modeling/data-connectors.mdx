...
| `url` | [DataConnectorUrlRef](#dataconnectorlink-dataconnectorurlref) | true | The url(s) to access the data connector. |
...
#### DataConnectorUrlRef {#dataconnectorlink-dataconnectorurlref}
...
| [Fn::ManifestRef](#dataconnectorlink-fn::manifestref) | Refer a ConnectorManifest to build and derive the connector URL from |



#### Fn::ManifestRef {#dataconnectorlink-fn::manifestref}

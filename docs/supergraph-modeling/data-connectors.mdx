...
| Key       | Schema                                                | Required | Description                                                                                                                                                    |
| --------- | ----------------------------------------------------- | -------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `name`    | [DataConnectorName](#dataconnectorname)               | true     | The name of the data connector.                                                                                                                                |
...
| Key                       | Schema                                                                                     | Required | Description                                                                                 |
| ------------------------- | ------------------------------------------------------------------------------------------ | -------- | ------------------------------------------------------------------------------------------- |
| `dataConnectorName`       | [DataConnectorName](#dataconnectorname)                                                    | true     | The name of the data connector that this scalar type comes from.                            |
...
| Key                            | Schema                                     | Required | Description |
| ------------------------------ | ------------------------------------------ | -------- | ----------- |
| `comparisonExpressionTypeName` | [GraphQlTypeName](#graphqltypename) / null | false    |             |

...
| Key | Value | Required | Description |
|-----|-----|-----|-----|
| `algorithm` | [Algorithm](#authconfig-algorithm) | true | The algorithm used to decode the JWT. |
...
| Key | Value | Required | Description |
|-----|-----|-----|-----|
| `x-hasura-default-role` | [JWTClaimsMappingEntry_for_Role](#authconfig-jwtclaimsmappingentry_for_role) | true | JSON pointer to lookup the default role within the decoded JWT. |
| `x-hasura-allowed-roles` | [JWTClaimsMappingEntry_for_Array_of_Role](#authconfig-jwtclaimsmappingentry_for_array_of_role) | true | JSON pointer to lookup the allowed roles within the decoded JWT. |



#### JWTClaimsMappingEntry_for_Array_of_Role {#authconfig-jwtclaimsmappingentry_for_array_of_role}
...
| `path` | [JWTClaimsMappingPathEntry_for_Array_of_Role](#authconfig-jwtclaimsmappingpathentry_for_array_of_role) | false |  |



#### JWTClaimsMappingPathEntry_for_Array_of_Role {#authconfig-jwtclaimsmappingpathentry_for_array_of_role}
...
#### JWTClaimsMappingEntry_for_Role {#authconfig-jwtclaimsmappingentry_for_role}
...
|-----|-----|-----|-----|
| `literal` | string | false |  |
| `path` | [JWTClaimsMappingPathEntry_for_Role](#authconfig-jwtclaimsmappingpathentry_for_role) | false |  |



#### JWTClaimsMappingPathEntry_for_Role {#authconfig-jwtclaimsmappingpathentry_for_role}

...
| Key | Value | Required | Description |
|-----|-----|-----|-----|
| `x-hasura-default-role` | [JWTClaimsMappingEntry (Role)](#authconfig-jwtclaimsmappingentry_for_role) | true | JSON pointer to lookup the default role within the decoded JWT. |
| `x-hasura-allowed-roles` | [JWTClaimsMappingEntry (Array of Role)](#authconfig-jwtclaimsmappingentry_for_array_of_role) | true | JSON pointer to lookup the allowed roles within the decoded JWT. |



#### JWTClaimsMappingEntry (Array of Role) {#authconfig-jwtclaimsmappingentry_for_array_of_role}
...
| `path` | [JWTClaimsMappingPathEntry (Array of Role)](#authconfig-jwtclaimsmappingpathentry_for_array_of_role) | false |  |



#### JWTClaimsMappingPathEntry (Array of Role) {#authconfig-jwtclaimsmappingpathentry_for_array_of_role}
...
#### JWTClaimsMappingEntry (Role) {#authconfig-jwtclaimsmappingentry_for_role}
...
|-----|-----|-----|-----|
| `literal` | string | false |  |
| `path` | [JWTClaimsMappingPathEntry (Role)](#authconfig-jwtclaimsmappingpathentry_for_role) | false |  |



#### JWTClaimsMappingPathEntry (Role) {#authconfig-jwtclaimsmappingpathentry_for_role}

...
| `version`    | `v1`                                     | true     |             |
| `definition` | [AuthConfigV1](#authconfig-authconfigv1) | true     |             |
...
| Key       | Value                                        | Required | Description |
| --------- | -------------------------------------------- | -------- | ----------- |
| `webhook` | [AuthHookConfig](#authconfig-authhookconfig) | false    |             |
...
| Key          | Value                                    | Required | Description |
| ------------ | ---------------------------------------- | -------- | ----------- |
| `fixed`      | [JWTKeyConfig](#authconfig-jwtkeyconfig) | false    |             |
...
| Value                                              | Description                                                             |
| -------------------------------------------------- | ----------------------------------------------------------------------- |
| [undefined](#authconfig-undefined)                 | Get the bearer token from the `Authorization` header.                   |
| [JWTCookieLocation](#authconfig-jwtcookielocation) | Get the token from the Cookie header under the specificied cookie name. |
...
#### undefined {#authconfig-undefined}
...
| Key         | Value                                                | Required | Description |
| ----------- | ---------------------------------------------------- | -------- | ----------- |
| `locations` | [JWTClaimsMap](#authconfig-jwtclaimsmap)             | false    |             |
| `namespace` | [JWTClaimsNamespace](#authconfig-jwtclaimsnamespace) | false    |             |

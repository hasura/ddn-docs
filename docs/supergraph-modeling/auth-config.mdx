...
doesn't use any auth service and doesn't allow setting session variables with API requests. However, you
would want update the `AuthConfig` to use a custom webhook or JWT service for authentication to make use of Hasura's
powerful authorization features. The metadata examples below can help you configure your `AuthConfig` object to use your
own custom webhook or JWT service.
...
| Value                                  | Description    |
| -------------------------------------- | -------------- |
| [AuthConfig2](#authconfig-authconfig2) | Auth config V2 |
| [AuthConfig1](#authconfig-authconfig1) | Auth config V1 |
...
| `version`    | `v2`                                     | true     |                                                                        |
| `definition` | [AuthConfigV2](#authconfig-authconfigv2) | true     | Definition of the authentication configuration used by the API server. |

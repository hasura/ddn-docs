...
allowing to link it to [models](/supergraph-modeling/models.mdx) and [commands](/supergraph-modeling/commands.mdx). It
...
A `DataConnectorLink` can be [created using the CLI](/cli/commands/ddn_connector-link_add.mdx). Out of convenience, the
CLI will scaffold this file automatically for you when
[initializing a new connector](/cli/commands/ddn_connector_init.mdx).

A `DataConnectorLink` belongs to a single [subgraph](/project-configuration/subgraphs.mdx) and represents a connection
to a data source. It is used to link the data source to the subgraph's models, commands, and relationships. The contents
can be [updated using the CLI](/cli/commands/ddn_connector-link_update.mdx). This will introspect the data source and
...
This configuration is then used to [generate the metadata](/cli/commands/ddn_connector-link_add-resources.mdx)
...
- [Add models](/cli/commands/ddn_model_add.mdx)
- [Add commands](/cli/commands/ddn_command_add.mdx)
- [Add relationships](/cli/commands/ddn_relationship_add.mdx)

:::

To make a new data connector link and it's cascading metadata available in your supergraph, you'll need to
[create a new build](/cli/commands/ddn_supergraph_build_local.mdx) using the CLI after adding your resources.

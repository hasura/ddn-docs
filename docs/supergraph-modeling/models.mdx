...
| `description`      | `String`                                                                            | false    | Description of the model.                                                                     |
...
| `description`      | `String` | false    | Description of the select uniques configuration of the model.        |
...
| ---------------- | -------- | -------- | ---------------------------------------------------------- |
| `queryRootField` | `String` | true     | Name of the query root field to use in the GraphQL API.    |
| `description`    | `String` | false    | Description of the select many configuration of the model. |

:::note Description of select uniques and select many configuration of the models
...
E.g., if the model description is `description of the model`, then the description for the configurations will be as
follows:

1. select uniques: `Selects a single object from the model. Model description: description of the model`
2. select many: `Selects multiple objects from the model. Model description: description of the model`

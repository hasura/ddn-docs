...
| `version`    | `v1`                                                    | true     |             |
| `definition` | [TypePermissionsV1](#typepermissions-typepermissionsv1) | true     |             |
...
| `version`    | `v1`                                                       | true     |             |
| `definition` | [ModelPermissionsV1](#modelpermissions-modelpermissionsv1) | true     |             |
...
| Key               | Value                                                                  | Required | Description |
| ----------------- | ---------------------------------------------------------------------- | -------- | ----------- |
| `fieldComparison` | [FieldComparisonPredicate](#modelpermissions-fieldcomparisonpredicate) | false    |             |
| `fieldIsNull`     | [FieldIsNull](#modelpermissions-fieldisnull)                           | false    |             |
| `relationship`    | [RelationshipPredicate](#modelpermissions-relationshippredicate)       | false    |             |
...
#### FieldIsNull {#modelpermissions-fieldisnull}

| Key     | Value                                    | Required | Description |
| ------- | ---------------------------------------- | -------- | ----------- |
| `field` | [FieldName](#modelpermissions-fieldname) | true     |             |
...
| `version`    | `v1`                                                             | true     |             |
| `definition` | [CommandPermissionsV1](#commandpermissions-commandpermissionsv1) | true     |             |

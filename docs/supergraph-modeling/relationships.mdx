...
| `description` | `String`                                                                                                               | false    | The description of the relationship.                                                             |
...
| Field     | Type                              | Required | Description                                                |
| --------- | --------------------------------- | -------- | ---------------------------------------------------------- |
| `command` | [`TargetCommand`](#targetcommand) | true     | The target [command](./commands.mdx) for the relationship. |

...
In an e-commerce context, you might have `Order` and `Customer` models, and you want to link them so that you can
fetch a customer's details for a given order.

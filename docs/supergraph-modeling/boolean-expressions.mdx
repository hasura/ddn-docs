...
filters are available for a model or command.

You can see an example of boolean expressions in the [filtering](/docs/3.0/graphql-api/queries/filters/index) section.

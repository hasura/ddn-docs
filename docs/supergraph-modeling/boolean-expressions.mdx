...
filters are available for a [model](/supergraph-modeling/models.mdx) or [command](/supergraph-modeling/commands.mdx).
They can be used to configure filters on models, such as in the [filtering](graphql-api/queries/filters/index.mdx)

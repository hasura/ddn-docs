---
sidebar_position: 1
sidebar_label: Upgrading deprecated metadata
...
# Upgrading deprecated metadata

Codemods upgrade your metadata to the latest version so you can take advantage of the latest engine features.

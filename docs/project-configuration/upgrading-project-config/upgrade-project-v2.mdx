...
A new revision (**2024.06.06**) of the [DDN CLI](/cli/installation.mdx) has been released. With this release, local project directory
structures created by CLI versions **\<= 2024.06.05** are now out-of-date and deprecated.

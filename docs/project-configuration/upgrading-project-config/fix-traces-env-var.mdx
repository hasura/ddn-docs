---
sidebar_position: 4
sidebar_label: Fix environment variable for OTLP endpoint
...
In previous versions of the DDN CLI, the environment variable `OTEL_EXPORTER_OTLP_TRACES_ENDPOINT`
...
This will change fix the name of the environment variables in the connector configuration files and docker compose files.

...
For cloud builds you first need your [cloud project and subgraphs](/getting-started/deployment/01-create-a-project.mdx)
set up.
...
Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac purus sit amet nisl tincidunt tincidunt. Nullam
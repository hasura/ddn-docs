...
A supergraph build is a fully-functional, immutable [supergraph](/how-to-build-with-ddn/overview.mdx) API which is
...
Follow the steps in the [Quickstart](/quickstart) to set up a project with a supergraph, in order work with builds.
...
For cloud builds you first need your
[cloud project and subgraphs](/deployment/hasura-ddn/deploying-your-project/tutorial/01-create-a-project.mdx) set up.

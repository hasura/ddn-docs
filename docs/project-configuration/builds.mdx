...
The format of a build is not something you will need to be concerned with, or need to edit, but it is set of large JSON objects which describes the supergraph.

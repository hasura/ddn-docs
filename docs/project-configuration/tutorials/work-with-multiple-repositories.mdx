...
deploy changes efficiently without impacting other subgraphs, ensuring a smooth and collaborative development
experience.
...
:::warning Take care to stop all running services

As a multi-repository setup is intended be utilized by multiple persons across teams, you're not likely to have multiple
instance of your Hasura DDN Engine and other services running at the same time on your machine. Ensure you've killed all
active services before proceeding to the next step for the `billing` subgraph.
...
As a multi-repository setup is intended be utilized by multiple persons across teams, you're not likely to have multiple
instance of your Hasura DDN Engine and other services running at the same time on your machine. Ensure you've killed all
active services before proceeding to the next step.

...
| [`supergraph.yaml`](#supergraphfiles)        | File that describes the supergraph.                                                                                        |
| [`connector.yaml`](#connectoryaml)           | File that describes the connector.                                                                                         |
...
| [`.hasura/context.yaml`](#contextfile)       | File that specifies the default project and supergraph of a project.                                                       |
...
`generator`.`rootPath` is specifies the directory into which any new files will be generated.

...
| [`.env.*`](#envfiles)                        | Files that stores environment variables.                                                                                   |
...
| [`.hasura/context.yaml`](#contextfile)       | File that specifies the default project and supergraph.                                                                    |
| `docker-compose.*.yaml`                      | Docker Compose files for local development.                                                                                |
| [`engine`](#engine)                          | Files mounted to the Docker container V3 Engine for local development.                                                     |

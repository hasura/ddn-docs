...
| [`supergraph_globals`](#supergraph-globals) | A directory, containing all the necessary configuration and metadata files, for the supergraph-level scope of a project. |
...
### Supergraph Globals {#supergraph-globals}

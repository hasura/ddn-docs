...
4. It's recommended to setup [subgraph prefixes](/project-configuration/subgraphs/subgraph-prefixing.mdx) at this stage.
...
5. Subgraph collaborators may also at this stage set
   [subgraph prefixes](/project-configuration/subgraphs/subgraph-prefixing.mdx) to prevent conflicts with the main
   project if needed.

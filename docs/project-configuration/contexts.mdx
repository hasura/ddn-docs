...
description: "Learn about managing contexts for the DDN CLI"
keywords:
  - hasura ddn
  - hasura cli
  - hasura local dev
...
To work with contexts, follow the steps in the [Quickstart](/quickstart) to set up a project with a supergraph.

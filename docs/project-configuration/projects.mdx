...
[builds](/project-configuration/builds.mdx) which are snapshots of the project config and are used to serve your API.
...
For more information on the project configuration files, see the [configuration section](/project-configuration/config.mdx).

#### Create builds

In order to see configurations in your metadata take effect you need to create a build. Head over to the
[Builds](/project-configuration/builds.mdx) section to learn about how to create and manage builds.

...
<Tabs groupId="source-preference">
  ...
  <TabItem value="python" label="Python">
    ...
    ```bash title="Track the function:"
    ddn command add my_python nameToUpperCase
    ```
  ...
  <TabItem value="go" label="Go">
    ...
    func FunctionNameToUpperCase(ctx context.Context, state *types.State, arguments *NameArguments) (*NameResult, error) {
        ...
        upperCaseName := NameResult(arguments.Name.ToUpper())
...
```bash title="Track your new relationship:"
ddn relationship add <connector_name> screamedName
```

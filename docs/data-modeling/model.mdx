...
import ModelCreatePostgreSQL from "./_partials/_classic-connectors/_postgreSQL/_model-create-tutorial.mdx";
import ModelCreateMongoDB from "./_partials/_classic-connectors/_mongoDB/_model-create-tutorial.mdx";
import ModelCreateClickHouse from "./_partials/_classic-connectors/_clickHouse/_model-create-tutorial.mdx";
import ModelCreateNativeQueryHowToPostgreSQL from "./_partials/_classic-connectors/_postgreSQL/_model-create-native-query-how-to.mdx";
import ModelCreateNativeQueryTutorialPostgreSQL from "./_partials/_classic-connectors/_postgreSQL/_model-create-native-query-tutorial.mdx";
import ModelCreateNativeQueryHowToMongoDB from "./_partials/_classic-connectors/_mongoDB/_model-create-native-query-how-to.mdx";
import ModelCreateNativeQueryTutorialMongoDB from "./_partials/_classic-connectors/_mongoDB/_model-create-native-query-tutorial.mdx";
import ModelCreateNativeQueryHowToClickHouse from "./_partials/_classic-connectors/_clickHouse/_model-create-native-query-how-to.mdx";
import ModelCreateNativeQueryTutorialClickHouse from "./_partials/_classic-connectors/_clickHouse/_model-create-native-query-tutorial.mdx";
...
Find a tutorial on how to add a native query for your data connector in the relevant section [here](/).

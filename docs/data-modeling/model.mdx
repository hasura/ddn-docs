...
import ModelExtendNativeQueryHowToPostgreSQL from "@site/docs/data-modeling/_partials/_classic-connectors/_postgreSQL/_model-extend-native-query-how-to.mdx";
import ModelExtendNativeQueryTutorialPostgreSQL from "@site/docs/data-modeling/_partials/_classic-connectors/_postgreSQL/_model-extend-native-query-tutorial.mdx";
import ModelExtendNativeQueryHowToMongoDB from "@site/docs/data-modeling/_partials/_classic-connectors/_mongoDB/_model-extend-native-query-how-to.mdx";
import ModelExtendNativeQueryTutorialMongoDB from "@site/docs/data-modeling/_partials/_classic-connectors/_mongoDB/_model-extend-native-query-tutorial.mdx";
import ModelExtendNativeQueryHowToClickHouse from "@site/docs/data-modeling/_partials/_classic-connectors/_clickhouse/_model-extend-native-query-how-to.mdx";
import ModelExtendNativeQueryTutorialClickHouse from "@site/docs/data-modeling/_partials/_classic-connectors/_clickhouse/_model-extend-native-query-tutorial.mdx";
...
<Tabs groupId="source-preference" className="api-tabs">
  <TabItem value="PostgreSQL" label="PostgreSQL">
    ...
    <ModelExtendNativeQueryHowToPostgreSQL />

  </TabItem>
  <TabItem value="MongoDB" label="MongoDB">

    <ModelExtendNativeQueryHowToMongoDB />

  </TabItem>
  <TabItem value="ClickHouse" label="ClickHouse">

    <ModelExtendNativeQueryHowToClickHouse />
...
<Tabs groupId="source-preference" className="api-tabs">
  <TabItem value="PostgreSQL" label="PostgreSQL">
    ...
    <ModelExtendNativeQueryTutorialPostgreSQL />

  </TabItem>
  <TabItem value="MongoDB" label="MongoDB">

    <ModelExtendNativeQueryTutorialMongoDB />

  </TabItem>
  <TabItem value="ClickHouse" label="ClickHouse">

    <ModelExtendNativeQueryTutorialClickHouse />

...
import CommandCreatePostgreSQL from "@site/docs/data-modeling/_partials/_classic-connectors/_postgreSQL/_command-create.mdx";
import CommandCreateMongoDB from "@site/docs/data-modeling/_partials/_classic-connectors/_mongoDB/_command-create.mdx";
import CommandCreateClickHouse from "@site/docs/data-modeling/_partials/_classic-connectors/_clickhouse/_command-create.mdx";
import CommandUpdatePostgreSQL from "@site/docs/data-modeling/_partials/_classic-connectors/_postgreSQL/_command-update.mdx";
import CommandUpdateMongoDB from "@site/docs/data-modeling/_partials/_classic-connectors/_mongoDB/_command-update.mdx";
import CommandUpdateClickHouse from "@site/docs/data-modeling/_partials/_classic-connectors/_clickhouse/_command-update.mdx";

# Commands Modify Data

## Introduction

In DDN, **Commands** represent operations that modify data in your data sources, such as inserts, updates, deletes, or
...
[CLI context](/getting-started/overview.mdx) section. {/* TODO UPDATE LINK */}

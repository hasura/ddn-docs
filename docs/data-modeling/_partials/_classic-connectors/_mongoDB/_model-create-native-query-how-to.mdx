...
- Create a new MongoDB [aggregation pipeline](/connectors/mongodb/native-operations/native-queries.mdx) which defines
  the native query in your connector's directory.
- Name the file with how you want to reference it in your supergraph API.
- Use the DDN CLI plugin for the MongoDB connector to add the native query to the connector's configuration eg:
...
Find out more about [native queries for MongoDB here](/connectors/mongodb/native-operations/native-queries.mdx).

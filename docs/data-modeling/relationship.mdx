...
Relationships are defined between a source object type and a target model or command.

The target model can be from the same or different data connector, or be created with a native query.
...
Relationships can be added between any kind of semantically related models or commands. They do not need to be backed by

...
import PostgresRelationshipCreateModelToModel from "./_partials/_classic-connectors/_postgreSQL/_relationship-create-model-to-model.mdx";
import MongoDBRelationshipCreateModelToModel from "./_partials/_classic-connectors/_mongoDB/_relationship-create-model-to-model.mdx";
import ClickHouseRelationshipCreateModelToModel from "./_partials/_classic-connectors/_clickHouse/_relationship-create-model-to-model.mdx";

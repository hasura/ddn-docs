...
<TabItem value="Phoenix" label="Apache Phoenix">

| ENV        | Example                              | Description                                                                |
| ---------- | ------------------------------------ | -------------------------------------------------------------------------- |
| `JDBC_URL` | `jdbc:phoenix:localhost:2181:/hbase` | This connector requires a JDBC URL calling out the port and database name. |

...
| ENV                        | Example                               | Description                                                                                                    |
| -------------------------- | ------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `STRIPE_BEARER_AUTH_TOKEN` | `sk_<test\|prod>_<unique_identifier>` | An auth token retrievable from your [API Keys dashboard in Stripe](https://dashboard.stripe.com/test/apikeys). |

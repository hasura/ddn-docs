...
returns an object of type `commandArticle`.
[The command is backed by a function](/data-domain-modeling/common-syntax.mdx/#typemappings) called `get_article_by_id`

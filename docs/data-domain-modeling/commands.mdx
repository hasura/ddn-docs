...
| `typeMapping`             | [`TypeMapping`](./common-syntax.mdx#typemapping)   | false    | [Type](./types.mdx) mappings for the command from OpenDD types used in the command inputs/outputs to the corresponding data connector types. |

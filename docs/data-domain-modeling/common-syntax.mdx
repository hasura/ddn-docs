...
description: Explore common OpenDD Spec Syntax such as ModelPredicate, FieldComparison, Relationship in Hasura Open Data Domain Specification. Great for understanding Hasura's data modelling.

...
description: "In-depth guide to common OpenDD Spec Syntax in Hasura including ModelPredicate, FieldComparison, and RelationshipPredicate. Learn how to effectively define filtering and permissions, compare fields, and create relationship predicates."
keywords:
  - hasura ddn
  - opendd syntax
  - hasura metadata
...
This predicate evaluates to true if any of the corresponding target objects of the relationship of the source model's object type with `name` meet the the nested `predicate`.
```yaml
relationship:

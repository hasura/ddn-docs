...
[commands](/data-domain-modeling/commands.mdx) to define the mapping between the fields of the OpenDD `outputType`
and the fields of the `result_type` of the `function` or `procedure`. It has the following fields:

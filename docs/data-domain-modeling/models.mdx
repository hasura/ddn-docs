...
description: Learn how to create and manage Hasura data domain models. These models are crucial links between your data sources and the Hasura generated API.
...
In this example, we're creating a model called `Authors` backed by a database table called `authors` in the `db` data source:

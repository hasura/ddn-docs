...
description:
  Dive into the OpenDD spec and Hasura v3 metadata which offers highly flexibile configuration and advanced capabilities
  for managing your data models and supergraph API. Understand the OpenDD spec structure, data connectors, types,

...
The [data connector](./data-connectors.mdx) will define where the data is coming from. It can be a database, a REST API, a
GraphQL API, etc. The data connector will use the [Native Data Connector](/connectors/overview.mdx) protocol to connect to the data

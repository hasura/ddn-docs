...
[Primitives and container types](/data-domain-modeling/types.mdx#primitive-and-container-types) are also defined at the
...
The [`ObjectType`](/data-domain-modeling/types.mdx#object-types) object allows you to create completely new types.

#### The ScalarType object

The [`ScalarType`](/data-domain-modeling/types.mdx#scalar-types) object allows aliasing other types.

#### The DataConnectorScalarRepresentation object

The [`DataConnectorScalarRepresentation`](/data-domain-modeling/types.mdx#scalar-type-representation) object allows
...
The [Command](/data-domain-modeling/commands.mdx) object defines the name of the command, the arguments to the
...
The [`Relationship`](/data-domain-modeling/relationships.mdx) object defines a relationship between a source

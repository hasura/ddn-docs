...
The OpenDD metadata defines a space of what data is available and its types, where it resides, how to access it and who
has authority to access it. Metadata is combined with Native Data Connectors (NDCs), services to communicate with
data sources in order to build your API.

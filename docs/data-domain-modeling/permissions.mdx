...
and [output types](./types.mdx) in your Open DD data domain.

Permissions in an API are essential for ensuring data security and maintaining resource integrity. They restrict access
to sensitive data and operations to authorized users, reducing the risk of unauthorized or malicious activity and is
important for compliance with legal and regulatory standards.

In your Open DD spec metadata:

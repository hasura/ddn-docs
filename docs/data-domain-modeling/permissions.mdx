...
description: Learn how to define permissions, access control or authorization rules on output types, models and commands in Hasura's OpenDD Spec. Useful for managing roles and accessibility.

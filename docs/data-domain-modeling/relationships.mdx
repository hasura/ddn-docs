...
The OpenDD spec doesn't distinguish between local or remote data relationships. If you have data sources present on a Hasura v3 project, Hasura will
automatically identify this and make efficient queries based on that distinction.

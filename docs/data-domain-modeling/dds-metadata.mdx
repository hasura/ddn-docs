...
data domain can seamlessly serve data even after a source migration, data distribution or any changes that you make to
your data store with minimal changes in the OpenDDS metadata.

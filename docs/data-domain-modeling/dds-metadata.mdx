...
| selectUniques        | [[SelectUnique](/graphql-api/queries/simple-queries.mdx#selectunique-structure)] | true     | Define Select unique queries.                                                                                                   |
| selectMany           | [SelectMany](/graphql-api/queries/simple-queries.mdx#selectmany-structure)               | false    | Definition to enable select many query.                                                                                         |
...
1. select-unique queries [here](/graphql-api/queries/simple-queries.mdx#examples).
2. select-many queries [here](/graphql-api/queries/simple-queries.mdx#examples-1).

## Scalar Type GraphQL Expression

For [Select Many](/graphql-api/queries/simple-queries.mdx#examples-1) queries, it is necessary to have a `where` argument to filter

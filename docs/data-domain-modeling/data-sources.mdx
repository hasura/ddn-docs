...
description: Learn how to configure data sources for Hasura OpenDD spec.
...
In this example, we'll create a data source for the Chinook data set. The Chinook data set is a sample database that
represents a digital media store, including tables for artists, albums, tracks, and more. Each object we reference above is
present in the complete example below:

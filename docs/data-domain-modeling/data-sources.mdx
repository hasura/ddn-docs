...
description: Learn how to configure data sources for Hasura OpenDD spec. This guide covers SQL databases, NoSQL databases, REST APIs, GraphQL APIs, and more.

...
Type references are the types of fields and arguments that refer to other primitive or custom types and can mark them as
nullable, required or repeated (array).

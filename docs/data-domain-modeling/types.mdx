...
scalar name and a type representation. This `representation` can refer to any existing primitive, container, or custom
type. This can be a string or an object.

...
In the Open Data Domain Specification in Hasura DDN, types serve as the fundamental elements that define the
structure of your data.

Being able to define types in your data domain is beneficial because it provides you with the flexibility to define
them separately from the types in your data source.
...
"DataConnectorScalarRepresentation"`. To define a scalar type representation, you need to have a data source name, a

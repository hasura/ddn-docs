...
To create a data source, start by defining an OpenDD object with the "kind" set to "DataSource". This object should include
...
This field describes the collections present in the schema. Collections are essentially the fundamental abstraction of storing same data 
e.g. in a relational database, collections will refer to tables/views. 

The behaviour definition will include fields
( with their definitions). It can be denoted as:

...
| auth               | `DataSourceAuth`   | false    | Authentication configuration to access the data source connector.                                                      |
...
will be forwarded to the specified data source connector as `Authorization: Bearer <token>` header.

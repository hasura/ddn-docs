...
Once you've declared a Data Source, you can use it in your Model's configuration by referencing it with the source
property, connecting your model to your chosen data source.
...
Types track the valid representations of values as JSON. A type can be a named type, nullable type, or an Array type.

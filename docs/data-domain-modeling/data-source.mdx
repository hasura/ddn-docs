...
[referencing it with the source](/data-domain-modeling/models.mdx/#source) property, connecting your model to your chosen data source.
...
| data_connector_url | `DataConnectorURL` | true     | URL to access the data source connector (and region information for database).                                                                               |
...
`SchemaResponse` is an object that defines the types, schema, functions, etc. of the data source. 
This is usually provided by the `/schema` endpoint of the data connector. It contains the following fields:

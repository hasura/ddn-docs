...
- Invalid JSON syntax in filter expression
- Missing operator prefix ($)
- Using operators not defined in the field's boolean expression type
- Invalid field references
- Using logical operators when not enabled in the boolean expression type

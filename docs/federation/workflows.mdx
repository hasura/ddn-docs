...
Now, collaborators manage a separate local supergraph for development containing just their subgraph and changes
...
4. Once the subgraph collaborators have accepted the invitation, they can
   [set the project context](/project-configuration/contexts/) to the main project.

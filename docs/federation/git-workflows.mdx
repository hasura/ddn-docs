...
federation can connect to different data sources, with each subgraph managed in its own repository for added governance,
control and clean separation from other teams work. Subgraphs would also typically be named after the data domain they
encapsulate, such as `users`, `orders`, `products`, etc.
...
4. It's recommended to setup [subgraph prefixes](/federation/subgraph-prefixes.mdx) at this stage.

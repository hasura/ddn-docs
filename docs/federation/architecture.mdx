...
When coupled with the [collaboration](/getting-started/collaborate/invite.mdx) features in Hasura DDN, this 
architecture enables more collaborative workflows and allows teams to independently develop and deploy subgraphs 

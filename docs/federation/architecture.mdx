...
Independent subgraph developmnent is only available on the [DDN Advanced plan](https://hasura.io/pricing/).
...
- Learn more about git workflows when building supergraphs in [single-repo or multi-repo](/federation/workflows.mdx)
  setups.

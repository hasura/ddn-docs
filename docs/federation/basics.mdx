...
[supergraph project initialized](/getting-started/build/01-init-supergraph.mdx).
...
[Getting Started guide](/getting-started/build/02-init-subgraph.mdx).

Once a subgraph has been added and built on Hasura DDN,
[subgraph collaborators](/getting-started/collaborate/invite.mdx) can be added to it.
...
Read more about [collaboration](/getting-started/collaborate/invite.mdx) and the available roles in Hasura DDN.

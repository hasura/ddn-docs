...
Once a subgraph has been added and built on Hasura DDN, [subgraph collaborators](/hasura-cloud/collaborate/invite.mdx)
can be added to it.
...
Read more about [collaboration](/hasura-cloud/collaborate/invite.mdx) and the available roles in Hasura DDN.

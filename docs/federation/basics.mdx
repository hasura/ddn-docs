...
[subgraph collaborators](/project-configuration/project-management/manage-collaborators.mdx) can be added to it.
...
Read more about [collaboration](/project-configuration/project-management/manage-collaborators.mdx) and the available
roles in Hasura DDN.

...
| DDN Plan     | Use Case                                                                        | Details                                                                                                                    |
| ------------ | ------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| DDN Free     | Ideal for individual developers building and running a supergraph at any scale. | <ul><li>Unlimited models, at any scale</li><li>1 supergraph developer</li><li>Observability: 15-minute retention</li></ul> |
| DDN Base     | Ideal for a single team building a business-critical supergraph.                | <ul><li>Unlimited supergraph developers</li><li>Observability: 30-day retention</li></ul>                                  |

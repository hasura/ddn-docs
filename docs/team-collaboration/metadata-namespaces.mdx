...
description: Explore Hasura's namespaces feature for better collaboration and improved organization in a multi-team project. Understand the utilization of namespaces in metadata and their ownership rules. 
keywords:
  - hasura
  - namespaces
  - collaboration tools

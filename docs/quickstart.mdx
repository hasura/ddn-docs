...
- ✅ [Sample metadata file](https://raw.githubusercontent.com/hasura/docs-sample-app/main/v3/sample_metadata.yaml)
  (following the OpenDD spec)
...
[Open Data Domain Specification (OpenDD spec)](https://github.com/hasura/open-data-domain-specification), and can be a
...
[here](https://raw.githubusercontent.com/hasura/docs-sample-app/main/v3/sample_metadata.yaml) 🎉
...
Models in the OpenDD spec refer to a collection of objects (such as rows in a relational database, or documents in a
NoSQL database) of a given OpenDD spec type. Models are backed by a data source and can support CRUD operations. You can
learn more about models [here](/data-domain-modeling/models.mdx).
...
header on the GraphiQL Explorer with your PAT. While you're there, you can also query your API — but, we're

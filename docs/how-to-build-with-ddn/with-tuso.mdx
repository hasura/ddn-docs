...
Head to [Turso](https://turso.tech) and create an account if you don't already have one. Then, create a new database
using their onboarding wizard.

#### Step 3.2. Create an auth token

From the database, create an auth token and save it as well.

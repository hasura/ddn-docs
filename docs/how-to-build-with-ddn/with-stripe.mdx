...
| -------------------------- | -------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| `STRIPE_BEARER_AUTH_TOKEN` | An auth token retrievable from your [API Keys dashboard in Stripe](https://dashboard.stripe.com/test/apikeys). | `sk_<test\|prod>_<unique_identifier>` |
...
Take a look at our Stripe docs to learn more about how to use Hasura DDN with Stripe. Or, if you're ready, get started

...
:::warning Oracle on Apple Silicon

Oracle does not support Apple Silicon. If you are using an Apple Silicon Mac, you can use Colima to run Oracle.

1. Install [Colima](https://github.com/abiosoft/colima#installation)
2. Run `colima start --arch x86_64 --memory 4`
3. Run the Docker commands below as normal
...
Take a look at our Oracle docs to learn more about how to use Hasura DDN with Oracle. Or, if you're ready, get started

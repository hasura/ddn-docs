...
INSERT INTO default.users (name, age) VALUES ('Alice', 25);
INSERT INTO default.users (name, age) VALUES ('Bob', 30);
INSERT INTO default.users (name, age) VALUES ('Charlie', 35);
```
...
- An access token — which you can generate from the same UI as where you found the base for your connection string.
...
Take a look at our Databricks docs to learn more about how to use Hasura DDN with Databricks. Or, if you're ready, get

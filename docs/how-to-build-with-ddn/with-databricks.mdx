...
- An access token — which you can generate with the `Create a personal access token` button in the top right in the same UI as where you found the base for your connection string.

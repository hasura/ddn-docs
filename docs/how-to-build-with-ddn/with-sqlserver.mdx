...
### Step 4. Start a local SQL Server container
...
There are a number of ways to connect to your SQL Server database. Here are some suggestions for tools that you can use.

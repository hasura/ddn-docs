...
:::tip VS Code SQL Server Extension

For an easy and conventient way to connect to your SQL Server database, download
[Visual Studio Code](https://code.visualstudio.com/) and install the

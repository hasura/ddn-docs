...
The beta release is ready for production. It is best used for read-only workflows. We are continuously adding new
features to achieve full feature parity with Hasura version 2 soon.
...
DDN Beta you'll soon be able to use Typescript directly for 'Action-like' functionality. What is better is that you'll
be able to host your Action webhooks/functions on Hasura itself. Moreover, we will be scaling support to most other
popular languages such as Java, GoLang, Rust, Python and more. Check out the

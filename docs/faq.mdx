...
DDN is completely free for 90 days for all Alpha users. See all the pricing information
...
community. We are expecting Hasura DDN to come out of alpha and hit General Availability within the first half of 2024.
...
The alpha release is ready for production. It is best used for read-only workflows. Mutations and business logic are
...
[//]:
  #
  "DDN Alpha will not be available as a self-hosted option. We are evaluating plans to meet the deployment needs of"
...
closer to Alpha and beyond) Depending on the origin of a request, we automatically activate an instance of Hasura in the
...
# If I have an Alpha DDN project, will it be compatible with the Alpha release?
...
DDN Alpha you can now use Typescript directly for 'Action-like' functionality. What is better is that now you can host

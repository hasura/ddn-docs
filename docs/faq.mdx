...
Yes. The aim of Hasura DDN is to provide the product at a price that is significantly lower than that of any self-hosted 
DIY API solution, regardless of the scale. 

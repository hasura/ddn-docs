...
performance and availability. This layer also offers tools for managing projects, builds, environments, env vars,
...
**Environments:** With environments you can design workflows that best mimic your software development lifecycle. Such
as development, staging and production, as well as individual developers testing enviropnments. Using environments
enables you to plan and manage infrastructure within your teams effectively.

**Builds and Project Shares:** With Hasura, metadata states are represented as builds. Once a build is thoroughly tested
and validated, it can be applied to a project as the live API (for any particular environment) and made available to API
consumers globally. This separation of build and production steps ensure a smoother transition from development to
production.
...
interact with a wide range of databases, services, and APIs. NDCs can be built for almost any conceivable source of
data and are the only way to connect to data sources in Hasura DDN.
...
Essentially, you don’t. You can rely on our [LSP](#LSP) to do much of the code generation and validation, but with
knowledge of Data Connectors you will better understand your Supergraph architecture and you can build custom
integrations to any data source or custom function or API.

[//]: # (TODO Rust link! Don't know where to link to)
...
the optimisations and features that Hasura DDN offers at the price point, our cloud service is the best way to use
...
DDN is completely free for 90 days for all Beta users. See all the pricing information
[here](https://hasura.io/pricing).
...
## Authoring metadata looks hard, how can I get started? {#LSP}
...
env vars, subgraphs and collaborators.
...
Database migrations are deprecated. We will provide a generated SQL file that you can use in an ORM tool of your choice.
We are open to any feedback on this product strategy. Do let us know about your pain point, and we can recommend a

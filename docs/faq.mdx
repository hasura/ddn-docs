...
functionality complete. As such, there may be some breaking changes introduced in the Alpha version. Customers are
able to use the platform in production but should do so with caution and at their own risk. Also, customer support
will be limited during this phase and most communication from Hasuras will happen via direct conversation with the

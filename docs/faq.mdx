...
DDN is completely free for 90 days for all Beta users. Stay tuned for additional pricing information.
...
The beta release should be used in production environments with care. The primary function of the beta release
is to engage early with the community at the while continuing to work to make the platform functionality complete.

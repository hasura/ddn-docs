...
To start evaluating v3, you can leverage the [GraphQL Connector](https://github.com/hasura/ndc-graphql) to bring in your v2 project as a subgraph in v3.
...
APIs, previously known as Remote Schemas, will be utilized via Native Data Connectors. Check out the newly released [GraphQL Connector](https://github.com/hasura/ndc-graphql) 
that you can use to bring in external GraphQL APIs in the low-code manner you are used to in
v2.
...
[stay tuned](https://github.com/hasura/graphql-engine/issues/10041) for more details.

...
**DDN CLI:** The new DDN CLI (Command-Line Interface), serves as a powerful tool for developers to interact with
...
**DDN Console:** The DDN Console has been revamped to enable rapid onboarding, testing and troubleshooting. The
...
you after which you can further author metadata using CLI commands and the VS
Code extension. The console is intended to tool and for running queries, visualization and monitoring.

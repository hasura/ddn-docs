...
sidebar_position: 11
description:
  "Explore the use of variables, aliases, fragments, and directives in Hasura queries. Learn to create dynamic and
  reusable queries, fetch data based on query parameters, and modify your GraphQL query results."
keywords:
  - hasura ddn
  - graphql variables
  - graphql aliases

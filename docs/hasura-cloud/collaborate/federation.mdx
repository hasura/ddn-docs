...
and teams to [work together as collaborators](/hasura-cloud/collaborate/invite.mdx) on subgraphs by assigning each user
...
`ux` and [invite developers](/hasura-cloud/collaborate/invite.mdx) from the team to collaborate on this subgraph via the
console.
...
[Follow the steps ](/hasura-cloud/collaborate/invite.mdx#invite-collaborators) to invite subgraph collaborators. Take
...
[Reference these docs](/hasura-cloud/collaborate/invite.mdx#accept-invite) to accept an invitation and explore the
existing supergraph.

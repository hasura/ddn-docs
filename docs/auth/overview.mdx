...
After authentication, session variables are passed via valid JWT or webhook to the engine to be checked against your
access control rules or "permissions".

## AuthConfig options

Authentication in Hasura DDN can be setup in one of three modes. These modes and their configuration options are

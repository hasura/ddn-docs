---
description: "Explore how to manage authorization in the Hasura Data Delivery Network (DDN). Understand how to utilize permissions in Hasura, with guides on how to control and access various elements such as output types, models, and commands in your data domain."
keywords:
...
- [**Type Permissions**](#type-permissions): Define which fields within a `ScalarType` or `ObjectType` can
be accessed by a particular role.
- [**Model Permissions**](#model-permissions): Define which rows within a

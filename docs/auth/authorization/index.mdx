---
description: "Explore how to manage authorization in Hasura Data Delivery Network (DDN). Understand how to utilize permissions in Hasura, with guides on how to control and access various elements such as output types, models, and commands in your data domain."
keywords:

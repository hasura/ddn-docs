...
- Learn how to [integrate JWTs](auth/jwt/index.mdx) to authenticate requests to Hasura DDN.
- Learn how to [integrate webhooks](auth/webhook/index.mdx) to authenticate requests to Hasura DDN.

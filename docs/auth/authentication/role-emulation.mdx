---
description: "Learn how to set up role emulation with Hasura, advancing your understanding of authentication configuration and the AuthConfig Hasura metadata object. Grasp the nuances of the allowRoleEmulationBy field and develop powerful control over session variables with this guide."
keywords: 
  - hasura
  - role emulation
  - authconfig

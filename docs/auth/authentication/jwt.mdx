---
description: "Secure your Hasura requests by learning how to configure Hasura Engine for JWT mode. Understand how to extract session variable claim values, authenticate incoming requests using JWT for powerful access control."
sidebar_position: 3
keywords:

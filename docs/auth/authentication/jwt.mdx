...
| `tokenLocation` | [Object](#jwt-token-location-values)                              | true     | Declares the request header or the cookie (with cookie name) from which to read the JWT. Default: `{"type": "tokenLocationValues"}`.                        |
...
[//]: # (  [See more here]&#40;/auth/authentication/auth/admin-secret-access.mdx&#41;)

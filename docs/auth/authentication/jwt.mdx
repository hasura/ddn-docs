---
description: "Secure your Hasura requests by learning how to configure Hasura Engine for JWT mode. Understand how to extract session variable claim values, authenticate incoming requests using JWT, and enable JWT mode for powerful access control."
sidebar_position: 3
keywords:
...
###### JWT claims map path object `<T>` {#jwt-claims-map-path-object}
...
The JWT Config to be used in the metadata can be generated using:

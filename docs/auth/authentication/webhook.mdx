---
description: "Get comprehensive information on how to configure Hasura to use webhook mode to authenticate incoming requests. Understand the process and requirements, and how to control the Hasura Engine's response to user authentication."
keywords:
  - hasura webhook mode

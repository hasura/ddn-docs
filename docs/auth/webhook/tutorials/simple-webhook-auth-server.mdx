...
## Configuring Hasura DDN

1. In your Hasura DDN project, go to the Authentication settings.
2. Enable Webhook mode.
3. Set the webhook URL to your server's endpoint (e.g., `http://localhost:3000/webhook`).
4. Configure your permissions based on the variables returned by the webhook.

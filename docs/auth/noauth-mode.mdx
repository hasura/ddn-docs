...
keywords:
  ...
  - supergraph
  - API
sidebar_label: NoAuth Mode Guide
---
...
[Read more about the `Role` value](/supergraph-modeling/auth-config.mdx#authconfig-role)
...
[Read more about the `SessionVariables` value](/supergraph-modeling/auth-config.mdx#authconfig-sessionvariables)

...
This namespace can be any string you choose, as long as it matches the `claims_namespace` defined in your AuthConfig.
Using `claims.jwt.hasura.io` will match our examples.

---
sidebar_position: 3
sidebar_label: Connector Directory
description: Learn how to author, set up, publish, and maintain connectors on the Hasura Connector Directory.
keywords:
  - hasura directory
  - connectors
...
# Connectors on the Hasura Directory
...
## Publishing your Connector on the Hasura Connector directory

All connectors listed on the directory currently require an entry in the
...
- A `README.md` file
  - This should be a condensed version of the `README.md` in your connector repository that acts as a quickstart guide
    for Hasura users.
- A `logo.png` file
  - This will appear next to your connector in the directory.
...
If you wish to have your connector listed on the directory, you should commit to making a best-effort to maintain the

...
description: Learn about data connectors: what they are and how to use the connector CLI plugin in Hasura. Discover how to create, deploy and manage data connectors in Hasura v3 projects.
keywords:
  - hasura
  - graphql
  - data connectors

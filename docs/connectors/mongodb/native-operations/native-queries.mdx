...
Managing native queries using the CLI requires version 1.5.0 or later of the MongoDB Connector CLI plugin. If you have
an earlier version please skip to the [Write native query configurations
directly](.#write-native-query-configurations-directly) section.

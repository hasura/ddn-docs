...
The environment variable you need to set and pass to the connector is `MONGODB_DATABASE_URI`. This is handled
for you when using ddn which you can map to another environment variable
[documented here](/project-configuration/config#envyaml).

...
[Native Mutations](/connectors/mongodb/native-mutations/index.mdx) will always need manual authorship currently. We plan
on improving this authorship flow in the future.

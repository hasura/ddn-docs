...
Custom mutations allow you to run custom commands on your MongoDB database using the [runCommand][MongoDB: runCommand]
...
1. Adding a `native_procedures` directory if one doesn't already exist in your connector configuration directory
...
:::tip Valid Native Procedure syntax

Check out our page on writing valid Hasura DDN [Native Query syntax](/connectors/mongodb/native-procedures/syntax.mdx).

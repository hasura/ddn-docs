---
description: "Master the deployment of a data connector for Hasura software with our comprehensive guide. Learn about HTTP connectors, integrated connectors, and how to use Hasura's CLI for effective deployment."
keywords:
...
```
hasura3 secret set --project-id $project-id CONNECTOR_TOKEN=SUPER_SECRET_TOKEN_XXX123
```

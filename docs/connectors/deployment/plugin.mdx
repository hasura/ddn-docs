...
description: "Learn how to manage and deploy custom Hasura Data Connector agents to Hasura Cloud using the Hasura CLI plugin. From installing to uninstalling the plugin, along with advanced usage options, this documentation delivers extensive knowledge on enhancing your data connections."
keywords:
  - hasura ddn
...
See the [CLI secret documentation](/cli/commands/secret.mdx) for information on how to securely configure secrets

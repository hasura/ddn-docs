...
description: Interact with connectors via the Hasura CLI.
keywords:
  - hasura
  - cli
  - plugin
...
[//]: # (See the [CLI cloud secret documentation]&#40;/cli/commands/cloud-secret.mdx&#41; for information on how to securly configure)

[//]: # (secrets such as this token in your projects.)

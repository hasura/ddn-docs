---
sidebar_position: 1
title: "Intro - Let's Build a Connector in TypeScript!"
...
You can follow along with the code in this tutorial by first cloning the [repo](/connectors/build-your-own/get-started/01-clone.mdx).

...
metaDescription: 'Learn how to implement observability features in a Hasura data connector using the Rust and TypeScript SDKs'
sidebar_position: 5
---

In this section, we focus on adding observability features to a Hasura data connector using the Rust and TypeScript
SDKs. Observability ensures we can monitor our connector's behavior in production, covering health checks, metrics, and tracing.

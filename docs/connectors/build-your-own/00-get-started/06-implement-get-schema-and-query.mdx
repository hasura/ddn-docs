...
Now we almost have a working connector apart from actually querying the database. Let's set up some testing, so we know
what we're working to and when we're done.

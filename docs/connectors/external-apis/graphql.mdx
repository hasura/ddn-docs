...
- `configuration.schema.json` - [JSON Schema](https://json-schema.org/) for your main configuration file. Allows your IDE to validate your configuration file, thus enhances configuration experience.
...
You may wish to connect to different endpoints for introspection and query execution.
...
You may wish to forward headers from the original request to the underlying connector.
To achieve this, set the `request.forwardHeaders` property to a non-empty array of string values.
Glob patterns are supported.

You will also have to modify your [connector link](/supergraph-modeling/data-connector-links/) to add the following [argument preset](/supergraph-modeling/data-connector-links.mdx#dataconnectorlink-dataconnectorargumentpreset) section:
...
Changing this configuration will modify the exposed NDC schema, which you will need to [update](/cli/commands/ddn_connector-link_update/).
...
You may want to forward request headers back to the client, typically when using the `Set-Cookie` header.
To achieve this, set the `response.forwardHeaders` property to a non-empty array of string values.
Glob patterns are supported.

You will also have to modify your [connector link](/supergraph-modeling/data-connector-links/) to add the [response header](/supergraph-modeling/data-connector-links.mdx#dataconnectorlink-responseheaders) section:

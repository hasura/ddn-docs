...
To get started with the OpenAPI data connector, you can follow the
[getting started guide here](/getting-started/build/03-connect-to-data/01-connect-a-source.mdx?db=OpenAPI).

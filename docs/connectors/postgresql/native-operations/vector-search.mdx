...
metadata ([see instructions here](/docs/getting-started/connect-to-data/03-add-source-entities.mdx)). Then, you would
need to add a relationship from the generated `ProductsVectorDistance` type to the main `Products` model, like this:

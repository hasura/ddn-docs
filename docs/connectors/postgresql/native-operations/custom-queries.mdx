...
Native Query allow you to run custom SQL queries on your PostgreSQL database. This allows you to run queries that are
...
The SQL structure of a Native Query is specified in the [Native Operation syntax](/connectors/postgresql/native-operations/syntax.mdx) page.
...
2. Create a new SQL file `my_subgraph/connector/chinook_pg/native_operations/queries/artist_by_name_between.sql`

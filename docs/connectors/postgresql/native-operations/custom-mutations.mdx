...
[Native Operation syntax](/connectors/postgresql/native-operations/syntax.mdx) page, but require an important tweak:
...
4. Add a source entity as described in our
   [add source entities](/getting-started/build/03-connect-to-data/03-add-source-entities.mdx) guide.

...
Running the [ddn connector introspect](/cli/commands/ddn_connector_introspect.mdx) command tells the CLI to update
the `ndc-postgres` configuration. Note that the `metadata.tables` part of the configuration will be refreshed and

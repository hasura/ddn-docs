...
Our policy is to support all versions which are indicated as being supported in the [PostgreSQL releases table here](https://www.postgresql.org/support/versioning/). 

...
- Point mutations - Auto-generated insert, delete, and update mutations which operate on a single row. Available by
  setting the [mutationsVersion](/connectors/postgresql/configuration-reference/version-4#mutationsversion-v2)
  configuration option to `"v2"`.
- [Native Mutations](/connectors/postgresql/native-operations/custom-mutations.mdx) - custom SQL queries that can be
  exposed via the GraphQL engine.

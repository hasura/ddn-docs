...
This error message indicate that there was a problem connecting to the database. Some common issues are a typo in the connection string,
...
the same connection string supplied to ndc-postgres.

### I've changed my database schema and would like these changes propegated in Hasura

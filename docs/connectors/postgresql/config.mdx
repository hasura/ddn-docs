...
Native queries can be defined by adding them to the `metadata.nativeQueries` section of the connector configuration.
...
[`introspectionOptions.introspectPrefixFunctionComparisonOperators`](#introspectionoptionsintrospectprefixfunctioncomparisonoperators) are considered by

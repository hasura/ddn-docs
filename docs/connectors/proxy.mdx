...
Hasura's [Connector Hub](https://hasura.io/connectors) is designed to act as the new gold-standard for data-source
compatibility and works seamlessly with Hasura V3 projects to integrate diverse datasets and interactions in your
projects.

While this is immensly useful in a V3 context, what does it mean for your existing V2 projects? Will they be able to use
the new connectors?
...
When deploying your connector with the `connector create` plugin, simply enable the `ENABLE_V2_COMPATIBILITY` mode via

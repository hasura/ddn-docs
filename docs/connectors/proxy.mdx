...
description: Explore how to use a v3 Connector in a v2 project through the Hasura Proxy, ensuring seamless integration and compatibility of your data sources.
keywords:
  - hasura
  - graphql
  - proxy
...
When deploying your connector with the [`connector` plugin](/connectors/introduction.mdx#the-connector-cli-plugin), simply enable the `ENABLE_V2_COMPATIBILITY` mode via an

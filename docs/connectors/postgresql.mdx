...
description: Learn how to setup and configure the Hasura Native Data Connector for PostgreSQL. Enhance your query capabilities with the connector, understand its configuration structure. Discover how to define native queries, map SQL data types to GraphQL types, and perform various query operations.
keywords:
  - hasura
  - graphql
  - postgres
...
The connector supports all query operations; see the [query documentation](/graphql-api/postgresql-queries/index.mdx) for details.

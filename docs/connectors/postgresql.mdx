...
description: "Dive into how Hasura's Native Data Connector for PostgreSQL operates. Learn to setup, configure and manage your data through rich queries. Understand mapping of SQL data types, understand supported query operations, and navigate the limitations of currently unsupported nested data structures."
keywords:
  - hasura
  - postgresql
  - data connector

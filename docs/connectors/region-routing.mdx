...
to deploy your connector in a region closest to the data source to ensure efficient communication between the
connector and the data source.

For other data connectors, e.g. [Typescript](/business-logic/typescript.mdx), it is recommended to deploy your connector
...
data connector to a specific region.

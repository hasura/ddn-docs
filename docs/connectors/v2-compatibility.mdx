...
description: "Learn how to integrate a v3 Connector in a v2 Hasura project utilizing Hasura Proxy. This guide explores the process, compatibility considerations, configurations, usage and potential limitations for data integration in existing projects with v3 connectors."
keywords:
  - hasura v3 connector
  - data integration
  - hasura v2 project

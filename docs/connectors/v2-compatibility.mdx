---
sidebar_position: 7
sidebar_label: v2 Compatibility
description:
...
The [Hasura Connector directory](https://hasura.io/connectors) is designed to act as the new gold-standard for data
source compatibility and works seamlessly with Hasura v3 projects to integrate diverse datasets and interactions in your
projects.

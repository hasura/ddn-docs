...
1. As a supergraph admin, [create a supergraph normally](/quickstart.mdx), [deploy](/deployment/deployment/index.mdx)
   and apply on Hasura DDN, as per the [getting started guide](/quickstart.mdx).

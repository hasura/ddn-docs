...
Usage: hasura3 cloud secret set [OPTIONS] --project-id <project-id> --env <environment> --namespace <namespace> <secret>
...
Options:
  -p, --project-id <project-id>    Your Hasura Cloud Project ID
      ...
      --env <environment>          Environment where the secret will be added
      --log-level <log-level>      The log level to be printed in stdout [env:
                                   ...
                                   trace-all]
      --namespace <namespace>      Namespace where the secret will be added
  -h, --help                       Print help
```

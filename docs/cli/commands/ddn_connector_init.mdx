...
```bash
# Initialize a Postgres Connector "mydb" inside the directory for Subgraph "app"
 ddn connector init mydb --subgraph app --hub-connector hasura/postgres --supergraph supergraph.yaml

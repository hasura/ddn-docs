...
Additional behaviour can be configured using environment variables.

### `HASURA_DDN_PROJECT_DIRECTORY`

Set this to the path to your project directory (contains the hasura.yaml file). Useful for scripting.

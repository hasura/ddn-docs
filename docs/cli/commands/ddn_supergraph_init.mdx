...
# Initialize a new Supergraph project directory with a Hasura DDN Project
ddn supergraph init --dir <path-to-project-dir> --with-project foo-bar-1234
```
...
-h, --help                  help for init
    --with-project string   DDN project to associate the Supergraph with
```

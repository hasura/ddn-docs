...
<OverviewTopSectionIconNoVideo
  ...
  intro={
    <div>
      ...
      <p>
        You can create projects, apply builds, set secrets, and even tunnel to a secure local data source for
        development — all without leaving your favorite terminal.
      </p>
    </div>
  }
/>

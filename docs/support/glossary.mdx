...
data source must have connector URL and schema. [Learn more](/supergraph-modeling/data-connector-links.mdx).
...
web service endpoints that a connector needs to implement. [Learn more](/supergraph-modeling/data-connector-links.mdx).
...
[Learn more](/project-configuration/config.mdx#supergraph-config).
...
A data domain refers to the collection of data and operations for one area of the business, or team within the
business. This could be a single database, a set of databases, a database and business logic, some other 3rd party
APIs, or a combination of all of these.

...
1. [Using Cloudflare Wrangler](#using-cloudflare-wrangler)
2. [Using docker image](#using-docker-image)
...
Follow the steps in the [wrangler configuration](#step-3-add-the-plugin-configuration) section to add the plugin
configuration.

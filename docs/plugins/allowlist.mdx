...
description: Explore the Allowlist plugin, and how to incorporate it into your Hasura projects.
keywords:
  - hasura plugins
  - plugins
  - engine plugins
...
The [allowlist plugin](https://github.com/hasura/engine-plugin-allowlist) adds
an allowlist layer on top of your supergraph to restrict access to only
specific queries or mutations.

...
From the Data Plane details page, you can:

- **View** all your private endpoints and their status
- **Update** an endpoint to add or remove availability zones
- **Delete** an endpoint when it's no longer needed

...
## Default & Custom Resource Limits
...
- **Fixed CPU (Request & Limit)**: 1
- **Fixed RAM (Request & Limit)**: 2GB
...
- **Default RAM (Request)**: 256Mi
- CPU and memory **can** be customized for Hasura-provided connectors.
- The request values can be customized per each connector deployment.

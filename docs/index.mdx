...
<div className={"card-wrapper"}>
  <div className={"card"}>
    ...
    <Link href={"/basics/overview/"}>Learn the basics<ChevronRight /></Link>
  </div>
  <div className={"card"}>
    <div className={"card-content-items"}>
    ...
    <Link href={"/local-dev/"}>Deploy your first project<ChevronRight /></Link>
  </div>
  <div className={"card"}>
    <div className={"card-content-items"}>
    ...
    <Link href={"/graphql-api/overview"}>Learn about the GraphQL API<ChevronRight /></Link>
  </div>
</div>
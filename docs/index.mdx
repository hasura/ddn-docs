  ...
  <div className="sub-heading">
    <div className="front-matter">
      <p>
        ...
        <br />
        <br />
        Hasura Data Delivery Network (DDN) provides instant GraphQL API on various types of data sources. It's a new way for the backend teams to
        think of providing data access to the edge in a reliable, performant and secure manner.
        <br />
        <br />

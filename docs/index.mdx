...
<div className={'front-matter'}>
  <div>
    ...
    Hasura's approach is to facilitate connection between the Hasura Engine and data sources via
    [Data Connectors](/connectors/overview/) and to define these connections using simple, declarative metadata in
    order to create a rich Supergraph of interconnected data sources, business logic and 3rd party APIs.

...
description: Known limitations for DDN.
keywords:
  - Limitations
---
...
Being the first glimpse into Hasura DDN, the current release comes with some limitations:

- **Mutations, Event Triggers and Subscriptions:** Coming soon! Mutations and event triggers can be performed via
  [Commands](/supergraph-modeling/commands.mdx) in the current release though. Please do check commands and Typescript

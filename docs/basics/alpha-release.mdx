...
- [**Cloud Environment Variables:**](/ci-cd/cloud-environment-variables.mdx) a means of storing sensitive information as
  key-value pairs that you don't want exposed in your metadata.

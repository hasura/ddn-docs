...
Hasura DDN has been built for scale, both in terms of actual performance, and the size of teams which can
...
## Known limitations
  ...
  We are rapidly adding API features to Haura DDN. To keep up to date, please check out our [product roadmap](https://github.com/orgs/hasura/projects/201).

- **Mutations, Event Triggers and Subscriptions:** Coming soon! Mutations and event triggers can be performed via
  [Commands](/supergraph-modeling/commands.mdx). Please check out the commands and Typescript
  Connector out for [business logic](/getting-started/build/07-integrate-business-logic.mdx) and [mutations](/getting-started/build/09-mutate-data.mdx).
...
If you've been using Hasura v2 for building new greenfield applications, we will make sure that you'll be
far more productive and efficient when using Hasura v3 and DDN compared to Hasura v2 to build and manage APIs.

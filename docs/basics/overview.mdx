  ...
  intro={
    <div>
      <p>
        ...
        <p>This architecture is known as a <strong>Data Supergraph</strong>.</p>
        ...
        <ul className={"introList"}>
          ...
          <li>
            Data connectors for any conceivable source of data and build your own!
          </li>
          <li>
          ...
          <li>
            No single point of failure. Graph resiliency and fault tolerance.
          </li>
        </ul>

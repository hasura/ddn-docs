...
<OverviewTopSectionIconNoVideo
  ...
  intro={
    <div>
      <p>
        Hasura DDN is fundamentally about connecting data sources to the Hasura Engine via Data Connectors and to
        define these connections and relationships using a metadata standard.
      </p>
      <p>

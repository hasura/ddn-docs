...
source. The data connector is responsible for translating GraphQL queries into the native query language of the data
source.

Data connectors, which are built using the [NDC Specification](https://github.com/hasura/ndc-hub) and closely integrated

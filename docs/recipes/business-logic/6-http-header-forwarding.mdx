...
From CLI v2.18.0, you can use the codemod `ddn codemod configure-header-forwarding` to configure the
`DataConnectorLink` to forward headers to the connector.

...
include:
  #highlight-start
  - path: <subgraph-name>/connector/<connector-name>/compose.yaml
  #highlight-end
services:
  engine: ...
```
...
The CLI-generated environment variables for a subgraph typically start with the `<SUBGRAPH-NAME>_` prefix.

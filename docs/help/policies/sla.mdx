...
# Hasura DDN Service Level Agreement (SLA)

## Introduction

This document describes the Service Level Agreement (SLA) calculation and crediting process for Hasura DDN. The SLA
applies to paid tiers in Hasura DDN.
...
DDN Base users can find more detail regarding uptime in our
[terms of service](https://hasura.io/legal/hasura-cloud-terms-of-service/). Enterprise users should reference their
...
monthly subscription fee for affected Hasura DDN projects.

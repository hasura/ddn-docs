...
To report a security issue, please email us at [`security@hasura.io`](mailto:security@hasura.io) with the vulnerability
details, and attach the relevant information including screenshots/videos. The more details we have, the quicker will we
be able to fix any potential vulnerabilities.

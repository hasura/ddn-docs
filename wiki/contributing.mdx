...
```bash
git clone https://github.com/hasura/v3-docs.git
cd v3-docs
yarn install
yarn start
```
...
Head to the `hasura/v3-docs` repo and you should see a `Compare & pull request` button - click it to create you PR 🤙

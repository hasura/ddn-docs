...
<div className={'front-matter'}>
  ...
  <Thumbnail src="/img/small-sample-img.png" className="boderRadius0" alt="VSCode data connector" width="1000px" />
</div>
...
<Thumbnail src="/img/sample-img.png" className="boderRadius0" alt="VSCode data connector" width="1000px" />

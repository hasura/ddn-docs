...
const HeadingIcon = ({ icon, size }) => {
  ...
  return (
    <div className={`${styles["icon-container"]}`}>
      {icon === `cloud` && iconTheme === `dark` && (
        <CloudLight style={{ width: size, height: size }} />
      )}
      {icon === `cloud` && iconTheme === `light` && (
        <CloudDark style={{ width: size, height: size }} />
      )}
      {icon === `ee` && iconTheme === `dark` && (
        <EnterpriseLight style={{ width: size, height: size }} />
      )}
      {icon === `ee` && iconTheme === `light` && (
        <EnterpriseDark style={{ width: size, height: size }} />
      )}
      {icon === `cloud-ee` && iconTheme === `light` && (
        <CloudEEDark style={{ width: size, height: size }} />
      )}
      {icon === `cloud-ee` && iconTheme === `dark` && (
        <CloudEELight style={{ width: size, height: size }} />
      )}
    </div>
  );
};

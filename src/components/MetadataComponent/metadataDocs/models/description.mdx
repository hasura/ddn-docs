...
Reference: CustomTypeName

### definition.source.dataConnectorName {#lines8}
...
Reference: DataConnectorName

### definition.source.collection {#lines9}
...
### definition.filterExpressionType {#lines10}
...
### definition.orderableFields {#lines11-23}
...
Reference: OrderableField

### definition.graphql.selectMany.queryRootField {#lines12}
...
Reference: SelectManyGraphQlDefinition

### definition.graphql.selectUniques {#lines13}
...
Reference: SelectUniqueGraphQlDefinition

### definition.graphql.orderByExpressionType {#lines14}

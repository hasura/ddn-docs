...
```bash
ddn connector init my_mongo --dir my_subgraph/connector/my_mongo --hub-connector hasura/mongodb
```
...
be saved in the subgraph directory. In this example the CLI will create a `my_subgraph/connector/my_mongo` directory if
it doesn't exist.

We're assuming here that you've already [created your supergraph](/getting-started/01-init-supergraph.mdx), then
[added a subgraph](/getting-started/02-init-subgraph.mdx) and are now ready to add a MongoDB database via the MongoDB
Data Connector. If you haven't please go back and complete those steps.

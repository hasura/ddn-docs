...
You can write data to your database using the native MongoDB driver and the TypeScript connector.

Using a subgraph with a `hasura/nodejs` connector we'll create a function that writes data to a MongoDB database and
make it available as a mutation in the metadata.
...
- A new or existing Node.js connector <BaseUrlLink to="/getting-started/integrate-business-logic" text="subgraph" />

...
correspond to collections and objects in those collections, but you can also create them for  <BaseUrlLink
to="connectors/mongodb/native-queries/" text="native queries" />

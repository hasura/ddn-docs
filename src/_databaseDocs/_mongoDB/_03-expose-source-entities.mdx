...
<BaseUrlLink to="/supergraph-modeling/models" text="models" />.
...
<BaseUrlLink to="supergraph-modeling/models/" text="model" /> to our subgraph.
...
<BaseUrlLink to="connectors/mongodb/native-queries/" text="native queries" />

If you look in your `<subgraph-name>/connector/my_mongo/connector/my_mongo.hml` file, you'll see `object_types` for each

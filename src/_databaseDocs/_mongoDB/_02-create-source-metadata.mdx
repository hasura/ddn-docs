...
```yaml
include:
  - path: my_subgraph/connector/my_mongo/docker-compose.my_mongo.yaml
```
...
After this command runs, you can open the same `my_subgraph/metadata/my_mongo/my_mongo.hml` file and see your

...
Change the value of your `mypg` connetor's published port to `8082` to avoid port collisions with other connectors
...
The CLI has provided an `.env` file for our connector in the `<subgraph-name>/connector/mypg` directory. We can add a

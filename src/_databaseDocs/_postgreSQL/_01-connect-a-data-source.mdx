...
With your PostgreSQL connector initialized and configured, you're now ready to link it to your supergraph. This next
step will create Hasura-specific metadata based on your PostgreSQL data source, ensuring seamless integration and
functionality.

...
## Step 2. Include the PostgreSQL connector's compose file
...
The commands above started the connector, along with other services, and introspected your data source to create a JSON
configuration file.

...
If you look in your `my_subgraph/connector/my_pg/metadata/my_pg.hml` file, you'll see `object_types` for each table in
your PostgreSQL database. For each of these, you can run the following command to create a model:

```bash title="For example, with an object_type of users"
